package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_2930:IRoomContentLoader;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         events.addEventListener(RoomContentLoadedEvent.const_814,this.onContentLoaded);
      }
      ...
      {
         var _loc1_:* = null;
         if(this.var_584 == null || this.var_482 == null)
         {
            return;
         }
         this._state = const_1574;
         if(this.var_1081 != null)
         {
            _loc1_ = this.var_1081;
            this.var_1081 = null;
      ...
      {
         var _loc4_:* = null;
         var _loc2_:int = this.var_583.indexOf(param1);
         if(_loc2_ >= 0)
         {
            return;
         }
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         var _loc4_:int = this.var_583.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_583[_loc4_];
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this._state == const_649)
         {
            return;
         }
         if(this.var_54 == null)
         {
            this._state = const_649;
            return;
         }
         if(this.var_54.getGraphicAssetCollection(param1) != null)
         {
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(this.var_880.indexOf(_loc2_) < 0)
         {
            this.var_880.push(_loc2_);
         }
      }
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         {
            _loc2_ = this.var_880[0];
            this.var_880.splice(0,1);
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_54 == null || this.var_482 == null)
         {
            return;
         }
