package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_990:Number = 60;
      
      private static const const_1383:Number = 50;
      ...
      private var var_679:RoomObjectCache;
      
      private var var_555:Array;
      
      private var var_681:Array;
      
      private var var_1550:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2791:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_281.addChild(this.var_98);
         ...
         this.var_280 = new BitmapDataCache(1024 * 1024 * 16);
         var _loc6_:* = null;
         ...
         this.var_679 = new RoomObjectCache(_loc6_);
         this.var_816 = new ColorTransform();
         this.var_1035 = new Matrix();
      ...
      {
         this.var_556.x -= param1 - this.var_678;
         this.var_678 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_556.y -= param1 - this.var_680;
         this.var_680 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_903 = true;
            if(this.var_144 != null && !this.var_281.contains(this.var_144))
            {
               this.var_281.addChild(this.var_144);
               this.var_98.mask = this.var_144;
            }
         }
         else if(!param1 && this.var_903)
         {
            this.var_903 = false;
            if(this.var_144 != null && this.var_281.contains(this.var_144))
            {
               this.var_281.removeChild(this.var_144);
      ...
      {
         this.var_679.removeObjectCache(param1);
      }
      ...
      public function render(param1:int) : void
      {
         ...
         if(this.var_830 != this.var_2793 || this.var_828 != this.var_2789)
         {
            _loc8_ = true;
         }
         if(this.var_98.x != this.var_678 || this.var_98.y != this.var_680)
         {
            this.var_98.x = this.var_678;
            this.var_98.y = this.var_680;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_2793 = this.var_830;
         this.var_2789 = this.var_828;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1549 > 0)
         {
            _loc2_ = param1 - this.var_1549;
            if(_loc2_ > const_990 * 3)
            {
               Logger.log("Really slow frame update " + _loc2_ + "ms");
               this.var_2788 = _loc2_;
            }
            if(_loc2_ <= MAXIMUM_VALID_FRAME_UPDATE_INTERVAL)
            {
               ++this.var_827;
               if(this.var_827 == const_354 + 1)
               {
                  this.var_552 = _loc2_;
                  this.var_2004 = this.var_2792;
               }
               else if(this.var_827 > const_354 + 1)
               {
                  _loc3_ = Number(this.var_827 - const_354);
                  this.var_552 = this.var_552 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_2004 = this.var_2004 * (_loc3_ - 1) / _loc3_ + Number(this.var_2792) / _loc3_;
                  if(this.var_827 > const_354 + const_1384)
                  {
                     this.var_827 = const_354;
                     if(!this.var_1271 && this.var_552 > const_990)
                     {
                        this.var_1271 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1271 && this.var_552 < const_1383)
                     {
                        this.var_1271 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_679.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_679.getObjectCache(param2);
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_2006 && this.var_1271);
         ...
         _loc13_ += int(this.var_830 / 2);
         _loc14_ += int(this.var_828 / 2);
         var _loc16_:int = 0;
         var _loc17_:* = null;
         var _loc18_:* = null;
         var _loc19_:int = 0;
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_678;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_680;
                  if(_loc19_ < this.var_830 && _loc19_ + _loc22_.width >= 0 && (_loc20_ < this.var_828 && _loc20_ + _loc22_.height >= 0))
                  {
                     ...
                     _loc17_.x = _loc19_ - this.var_678;
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         if(param1 < this.var_829 || this.var_829 == 0)
         {
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:int) : BitmapData
      {
         ...
         if(param3 && param4 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc5_ = this.var_280.getBitmapData(_loc6_);
            }
            if(_loc5_ == null)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     this.var_280.addBitmapData(_loc6_,_loc5_);
                  }
                  return _loc5_;
               }
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            this.var_1035.identity();
            this.var_1035.scale(-1,1);
            this.var_1035.translate(data.width,0);
            finalData.draw(data,this.var_1035);
            if(name.length > 0)
            {
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            this.var_816.redMultiplier = tR;
            this.var_816.greenMultiplier = tG;
            this.var_816.blueMultiplier = tB;
            finalData.colorTransform(finalData.rect,this.var_816);
            if(name.length > 0)
            {
               this.var_280.addBitmapData(cacheName,finalData);
            }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_678;
         param2 -= this.var_680;
         this.var_556.x = param1;
         this.var_556.y = param2;
         if(this.var_1270 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
      ...
      {
         var _loc11_:Number = param1 - this.var_830 / 2;
         var _loc12_:Number = param2 - this.var_828 / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_2007,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  if(_loc12_.indexOf(_loc9_) < 0)
                  {
                     ...
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2790 || param2 != this.var_2791)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
      ...
      {
         if(this.var_393 != null && param1 != null)
         {
            this.var_393.add(param2,param1);
         }
      }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this._container == null || this.var_393 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = this.var_393.getKey(_loc1_);
            _loc3_ = this.var_393.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1550.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      public function update() : void
      {
         if(this.var_1270 == 0)
         {
            this.checkMouseHits(this.var_556.x,this.var_556.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_1270 = 0;
         ++this.var_2007;
      }
