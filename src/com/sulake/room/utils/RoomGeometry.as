package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_677:Number = 64;
      
      public static const const_1073:Number = 32;
      ...
      {
         this.var_1809.assign(this.var_149);
         return this.var_1809;
      }
      
      public function get location() : IVector3d
      {
         this.var_511.assign(this.var_92);
         this.var_511.x *= this.var_443;
         this.var_511.y *= this.var_442;
         this.var_511.z *= this.var_444;
         return this.var_511;
      }
      ...
      {
         if(this.var_443 != param1 * this.var_1811)
         {
            this.var_443 = param1 * this.var_1811;
            ++this.var_161;
         }
      }
      ...
      {
         if(this.var_442 != param1 * this.var_1810)
         {
            this.var_442 = param1 * this.var_1810;
            ++this.var_161;
         }
      }
      ...
      {
         if(this.var_444 != param1 * this.var_1808)
         {
            this.var_444 = param1 * this.var_1808;
            ++this.var_161;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_92.x /= this.var_443;
         this.var_92.y /= this.var_442;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_150.assign(_loc24_);
            this.var_149.assign(_loc25_);
         }
         else
         {
            this._x.assign(_loc18_);
            this.var_150.assign(_loc19_);
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_512 != null)
         {
            ...
            this.var_512.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_512.add(_loc3_,_loc4_);
            ++this.var_161;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_512 != null)
         {
            ...
            return this.var_512.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1159.assign(_loc22_);
         }
         else
         {
            this.var_1159.assign(_loc17_);
         }
         ++this.var_161;
      }
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc3_:Number = Vector3d.scalarProjection(param1,this.var_150);
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1159);
         if(_loc3_ < this.var_2910 || _loc3_ > this.var_2909)
         {
            return null;
         }
         var _loc4_:Number = Vector3d.scalarProjection(_loc2_,this._x);
         var _loc5_:Number = -Vector3d.scalarProjection(_loc2_,this.var_150);
         _loc4_ *= this._scale;
         _loc5_ *= this._scale;
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_442;
            _loc2_.z *= this.var_444;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1159);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         _loc7_.add(Vector3d.product(this.var_150,_loc6_));
         var _loc8_:Vector3d = new Vector3d(this.var_92.x * this.var_443,this.var_92.y * this.var_442,this.var_92.z * this.var_444);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_149;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_443,param2.y * this.var_442,param2.z * this.var_444);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_443,param3.y * this.var_442,param3.z * this.var_444);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_443,param4.y * this.var_442,param4.z * this.var_444);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1073;
         }
         else
         {
            this.scale = const_677;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_677;
      }
