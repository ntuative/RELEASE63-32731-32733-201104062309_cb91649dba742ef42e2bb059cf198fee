package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1266:String = "_CONTENT";
       
      
      protected var var_1064:ITabSelectorWindow;
      
      protected var var_2095:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1064 = findChildByTag(const_1267) as ITabSelectorWindow;
            if(this.var_1064 != null)
            {
               this.var_1064.procedure = this.selectorEventProc;
            }
         }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2095 = findChildByTag(const_1266) as IWindowContainer;
         }
      ...
      {
         return this.var_1064.numSelectables;
      }
