package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      {
         var _loc1_:TextField = TextFieldCache.getTextFieldByStyleName(this.var_423);
         if(_loc1_)
         {
      ...
      {
         if(this.var_423 != param1.name)
         {
            this.var_423 = param1.name;
            this.refresh();
         }
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2755 = _loc2_.textWidth;
         this.var_2756 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_390 != _loc2_.color : this.var_390 != null && this.var_390 != PropertyDefaults.const_762) ? new PropertyStruct(PropertyDefaults.const_385,this.var_390,PropertyStruct.const_149,true) : PropertyDefaults.const_1152);
         if(this.var_40)
         {
            if(this.var_40.left != PropertyDefaults.const_699)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_228,this.var_40.left,PropertyStruct.const_42,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_471);
            }
            if(this.var_40.top != PropertyDefaults.const_641)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_282,this.var_40.top,PropertyStruct.const_42,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_574);
            }
            if(this.var_40.right != PropertyDefaults.const_820)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_255,this.var_40.right,PropertyStruct.const_42,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_493);
            }
            if(this.var_40.bottom != PropertyDefaults.const_876)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_236,this.var_40.bottom,PropertyStruct.const_42,true));
            }
            else
            {
