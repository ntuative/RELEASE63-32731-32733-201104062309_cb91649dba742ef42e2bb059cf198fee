package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1241:IItemListWindow;
      
      private var var_452:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_452)
         {
            this.var_452.removeEventListener(WindowEvent.const_231,this.scrollBarEventProc);
            this.var_452.removeEventListener(WindowEvent.const_184,this.scrollBarEventProc);
            this.var_452 = null;
         }
         if(this.var_1241)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1241)
         {
            this.var_1241 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_452)
         {
            this.var_452 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_452)
            {
               this.var_452.addEventListener(WindowEvent.const_231,this.scrollBarEventProc);
               this.var_452.addEventListener(WindowEvent.const_184,this.scrollBarEventProc);
            }
         }
         return this.var_452;
      }
