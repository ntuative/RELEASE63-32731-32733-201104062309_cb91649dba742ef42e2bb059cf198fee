package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_929:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_928:String = "default";
      
      private var var_1132:String = null;
      
      private var var_1742:StyleSheet = null;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1132 == param2)
         {
            return;
         }
         param1.var_1132 = param2;
         param1.var_1742 = null;
         if(param1.var_1132 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1132);
            param1.var_1742 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_681.indexOf(param1) > -1)
         {
            this.var_928 = param1;
         }
      }
      ...
      {
         return this.var_928 == LinkTarget.const_29 ? defaultLinkTarget : this.var_928;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_20);
            _field.styleSheet = this.var_1742;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_922)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_928 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_835,this.var_928,PropertyStruct.const_54,true,PropertyDefaults.const_681));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_928 = _loc2_.value as String;
               break;
            }
