package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            _context.handleError(WindowContext.const_368,e);
         }
      }
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_388,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_729,false,PropertyStruct.const_40,true) : PropertyDefaults.const_1674);
         _loc1_.push(this.var_1324 != PropertyDefaults.const_1088 ? new PropertyStruct(PropertyDefaults.const_774,this.var_1324,PropertyStruct.const_40,true) : PropertyDefaults.const_1588);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1098 ? new PropertyStruct(PropertyDefaults.const_746,_field.selectable,PropertyStruct.const_40,true) : PropertyDefaults.const_1625);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1102 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_40,true) : PropertyDefaults.const_1474);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_729:
                  ...
                  break;
               case PropertyDefaults.const_1132:
