package com.sulake.core.window.components
{
   ...
   public class BitmapWrapperController extends WindowController implements IBitmapWrapperWindow, IBitmapDataContainer
   {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_567 != PropertyDefaults.const_1018)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_694,this.var_567,PropertyStruct.const_40,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1579);
         }
         if(this.var_867 != PropertyDefaults.const_1065)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_725,this.var_867,PropertyStruct.const_54,true));
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_694:
                  ...
                  break;
               case PropertyDefaults.const_725:
