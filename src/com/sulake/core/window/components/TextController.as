package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected var var_1065:Boolean = false;
      
      private var var_423:String = "regular";
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_423,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_423 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_423,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_682 ? true : null;
         }
      ...
      {
         return TextStyleManager.getStyle(this.var_423);
      }
      ...
      {
         return new Rectangle(this.var_869 * this.maxScrollH,this.var_569 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:TextStyle = TextStyleManager.getStyle(this.var_423);
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_1067) ? new PropertyStruct(PropertyDefaults.const_651,this._field.antiAliasType,PropertyStruct.const_54,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_1204) : PropertyDefaults.const_1583);
         _loc1_.push(this._autoSize != PropertyDefaults.const_1062 ? new PropertyStruct(PropertyDefaults.const_819,this._autoSize,PropertyStruct.const_54,true,PropertyDefaults.const_1027) : PropertyDefaults.const_1480);
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1122 ? new PropertyStruct(PropertyDefaults.const_1114,this._field.gridFitType,PropertyStruct.const_54,true,PropertyDefaults.const_1183) : PropertyDefaults.const_1494);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_762) ? new PropertyStruct(PropertyDefaults.const_385,this._field.textColor,PropertyStruct.const_149,true) : PropertyDefaults.const_1152);
         _loc1_.push(this.var_423 != TextStyleManager.const_201 ? new PropertyStruct(PropertyDefaults.const_418,this.var_423,PropertyStruct.const_54,true,PropertyDefaults.const_721) : PropertyDefaults.const_1082);
         _loc1_.push(this.var_40.left != PropertyDefaults.const_699 ? new PropertyStruct(PropertyDefaults.const_228,this.var_40.left,PropertyStruct.const_42,true) : PropertyDefaults.const_471);
         _loc1_.push(this.var_40.top != PropertyDefaults.const_641 ? new PropertyStruct(PropertyDefaults.const_282,this.var_40.top,PropertyStruct.const_42,true) : PropertyDefaults.const_574);
         _loc1_.push(this.var_40.right != PropertyDefaults.const_820 ? new PropertyStruct(PropertyDefaults.const_255,this.var_40.right,PropertyStruct.const_42,true) : PropertyDefaults.const_493);
         _loc1_.push(this.var_40.bottom != PropertyDefaults.const_876 ? new PropertyStruct(PropertyDefaults.const_236,this.var_40.bottom,PropertyStruct.const_42,true) : PropertyDefaults.const_559);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1153 ? new PropertyStruct(PropertyDefaults.const_668,this._field.mouseWheelEnabled,PropertyStruct.const_40,true) : PropertyDefaults.const_1461);
