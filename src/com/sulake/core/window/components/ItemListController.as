package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_2110:Boolean = false;
      ...
      protected var var_1069:Boolean = true;
      
      protected var var_479:Boolean = false;
      
      protected var var_1320:Boolean = false;
      
      protected var var_2108:int = 0;
      
      protected var var_2109:int = 0;
      
      protected var var_1321:Number;
      
      protected var var_1319:Number;
      
      protected var var_1322:Boolean = false;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_174 = var_477 || !testParamFlag(WindowParam.const_33);
         this._container = _context.create("_CONTAINER","",WindowType.const_358,WindowStyle.const_808,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         ...
         this.resizeOnItemUpdate = this.var_1320;
      }
      ...
      {
         return new Rectangle(this.var_704 * this.maxScrollH,this.var_703 * this.maxScrollV,width,height);
      }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            if(this._horizontal)
            {
               this._container.setParamFlag(WindowParam.const_551,param1);
            }
            else
            {
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_44:
               this.var_2108 = _loc3_;
               this.var_2109 = _loc4_;
               this.var_1321 = 0;
               this.var_1319 = 0;
               this.var_1322 = true;
               _loc2_ = true;
            ...
            case WindowMouseEvent.const_180:
               if(this.var_1322)
               {
                  this.var_1321 = this.var_2108 - _loc3_;
                  this.var_1319 = this.var_2109 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1321 != 0 && this.var_108 != 0)
                     {
                        this.scrollH += this.var_1321 / this.var_108;
                     }
                  }
                  else if(this.var_1319 != 0 && this.var_95 != 0)
                  {
                     this.scrollV += this.var_1319 / this.var_95;
                  }
                  this.var_2108 = _loc3_;
                  this.var_2109 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_194:
               if(this.var_1322)
               {
                  if(this._horizontal)
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1321,0);
                  }
                  else
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1319);
                  }
                  this.var_1322 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_1069 && !this.var_574 && this._container)
         {
            this.var_574 = true;
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_410,this._spacing,PropertyStruct.const_42,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1201);
         }
         if(this.var_1069 != PropertyDefaults.const_1193)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_855,this.var_1069,PropertyStruct.const_40,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1700);
         }
         if(this.var_479 != PropertyDefaults.const_1218)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_686,this.var_479,PropertyStruct.const_40,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1517);
         }
         if(this.var_1320 != PropertyDefaults.const_1115)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_749,this.var_1320,PropertyStruct.const_40,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1513);
         }
         if(this.var_701 != PropertyDefaults.const_1107)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_890,this.var_701,PropertyStruct.const_127,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1453);
         }
         if(this.var_702 != PropertyDefaults.const_1195)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_727,this.var_702,PropertyStruct.const_127,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1676);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_410:
                  this.spacing = _loc2_.value as int;
                  break;
               case PropertyDefaults.const_686:
               ...
               case PropertyDefaults.const_855:
                  this.var_1069 = _loc2_.value as Boolean;
                  break;
