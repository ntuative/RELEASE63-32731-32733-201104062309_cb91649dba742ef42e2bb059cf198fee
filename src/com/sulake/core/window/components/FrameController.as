package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1352:String = "_HEADER";
      
      private static const const_1351:String = "_CONTENT";
      
      private static const const_1353:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1508:IHeaderWindow;
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1508 = findChildByTag(const_1352) as IHeaderWindow;
            if(!this.var_1508)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_193 = findChildByTag(const_1351) as IWindowContainer;
            if(!this.var_193)
            {
      ...
      {
         return findChildByTag(const_1353) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1239,_loc2_,false);
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_228,_loc3_.left,PropertyStruct.const_42,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_282,_loc3_.top,PropertyStruct.const_42,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_255,0 - _loc3_.right,PropertyStruct.const_42,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_236,0 - _loc3_.bottom,PropertyStruct.const_42,_loc2_));
         }
         else
         {
