package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      public static const const_101:String = "hovering";
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_404 = SkinLayoutEntity.const_529;
                  break;
               case "move":
                  _loc5_.var_404 = SkinLayoutEntity.const_294;
                  break;
               case "strech":
                  _loc5_.var_404 = SkinLayoutEntity.const_468;
                  break;
               case "tiled":
                  _loc5_.var_404 = SkinLayoutEntity.const_308;
                  break;
               case "center":
                  _loc5_.var_404 = SkinLayoutEntity.const_1181;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_403 = SkinLayoutEntity.const_529;
                  break;
               case "move":
                  _loc5_.var_403 = SkinLayoutEntity.const_294;
                  break;
               case "strech":
                  _loc5_.var_403 = SkinLayoutEntity.const_468;
                  break;
               case "tiled":
                  _loc5_.var_403 = SkinLayoutEntity.const_308;
                  break;
               case "center":
                  _loc5_.var_403 = SkinLayoutEntity.const_1181;
            }
         }
