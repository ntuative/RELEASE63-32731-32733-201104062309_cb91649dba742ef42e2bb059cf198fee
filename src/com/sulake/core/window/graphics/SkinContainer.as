package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_986:uint = 8;
      
      private static const const_1372:String = "skin";
      
      private static const const_1376:String = "bitmap";
      
      private static const const_1374:String = "fill";
      
      private static const const_1375:String = "text";
      
      private static const const_1373:String = "label";
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         TypeCodeTable.fillTables(this.var_1980,this.var_2747);
         this.var_2748 = new Dictionary();
         this.var_2749 = new Dictionary();
         StateCodeTable.fillTables(this.var_2748,this.var_2749);
         this.var_457 = new Dictionary();
         this.var_457[const_1372] = BitmapSkinRenderer;
         this.var_457[const_1376] = BitmapDataRenderer;
         this.var_457[const_1374] = FillSkinRenderer;
         this.var_457[const_1375] = TextSkinRenderer;
         this.var_457[const_1373] = LabelRenderer;
         this.var_457[const_1377] = ShapeSkinRenderer;
         this.var_457[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_457[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_338 == null)
         {
            var_338 = new Array();
            var_338.push(WindowState.const_66);
            var_338.push(WindowState.const_85);
            var_338.push(WindowState.const_97);
            var_338.push(WindowState.const_56);
            var_338.push(WindowState.const_101);
            var_338.push(WindowState.const_84);
            var_338.push(WindowState.const_104);
         ...
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  this.addSkinRenderer(this.var_1980[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_1021[param1] = new Array(const_986);
         }
         this.var_1021[param1][param2] = param3;
         if(this.var_1022[param1] == null)
         {
            this.var_1022[param1] = new Array(const_986);
         }
         this.var_1022[param1][param2] = param4;
      }
      ...
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         ...
         if(_loc3_)
         {
            ...
            if(!_loc4_ && param2 != WindowStyle.const_198)
            {
               _loc4_ = _loc3_["null"];
            }
         }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1022[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_198)
