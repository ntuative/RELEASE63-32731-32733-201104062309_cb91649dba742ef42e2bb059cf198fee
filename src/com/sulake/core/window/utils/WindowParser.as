package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1858:String = "_INCLUDE";
      
      public static const const_1799:String = "_TEMP";
      
      private static const const_1413:String = "layout";
      
      private static const const_1004:String = "window";
      
      private static const const_1005:String = "variables";
      
      private static const const_1006:String = "filters";
      
      private static const const_434:String = "name";
      
      private static const const_1404:String = "style";
      
      private static const const_635:String = "params";
      
      private static const const_1411:String = "tags";
      ...
      private static const const_1401:String = "visible";
      
      private static const const_1414:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_5:String = "background";
      
      private static const const_1217:String = "blend";
      
      private static const const_1402:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1409:String = "treshold";
      
      private static const const_1405:String = "children";
      
      private static const const_1403:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1406:String = "height_min";
      
      private static const const_1412:String = "height_max";
      
      private static const const_636:String = "true";
      
      private static const const_168:String = "0";
      
      private static const const_1407:String = "$";
      
      private static const const_1387:String = ",";
      
      private static const const_50:String = "";
      
      private static const const_1408:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1410:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1326:Dictionary;
      
      protected var var_1325:Dictionary;
      
      protected var var_1074:Dictionary;
      
      protected var var_1590:Dictionary;
      
      protected var var_2115:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1326,this.var_1325);
         this.var_1074 = new Dictionary();
         this.var_1590 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1074,this.var_1590);
         this.var_2115 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1410,const_50);
         return param1.replace(const_1408,const_50);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1326)
            {
               delete this.var_1326[_loc1_];
            }
            for(_loc1_ in this.var_1325)
            {
               delete this.var_1325[_loc1_];
            }
            for(_loc1_ in this.var_1074)
            {
               delete this.var_1074[_loc1_];
            }
            for(_loc1_ in this.var_1590)
            {
               delete this.var_1590[_loc1_];
            }
            this.var_2115.dispose();
            this.var_2115 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         {
            _loc8_ = param1.child(const_1005);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_1006).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
            ...
            _loc4_ = param1.child(const_1004);
         ...
         if(param1.localName() == const_1004)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1326[xml.localName()];
         ...
         params = uint(this.parseAttribute(xml,const_635,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1411,variables,tag)));
         rect = new Rectangle();
         ...
         visible = this.parseAttribute(xml,const_1401,variables,visible.toString()) == const_636;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_635).length() > 0)
         {
            list = xml.child(const_635).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
         ...
         caption = unescape(String(this.parseAttribute(xml,const_1414,variables,caption)));
         if(tag != const_50)
         {
            tags = tag.split(const_1387);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1005)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1403,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1406,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1412,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_5,variables,window.background.toString()) == const_636;
         blend = Number(this.parseAttribute(xml,const_1217,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1402,variables,window.clipping.toString()) == const_636;
         ...
         list = xml.child(const_1006).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_50;
         var _loc3_:String = this.var_1325[param1.type];
