package com.sulake.core.window.utils
{
   ...
   public class PropertyStruct
   {
      ...
      public function PropertyStruct(param1:String, param2:Object, param3:String, param4:Boolean, param5:Array = null)
      {
         ...
         this.var_2914 = param3 == const_260 || param3 == const_131 || param3 == const_246 || param3 == const_244;
      ...
      public function toXMLString() : String
      {
         ...
         switch(this._type)
         {
            case const_260:
               ...
               _loc1_ = "<var key=\"" + this.var_654 + "\">\r<value>\r<" + this._type + ">\r";
               _loc2_ = 0;
            ...
            case const_244:
               ...
               break;
            case const_149:
               _loc1_ = "<var key=\"" + this.var_654 + "\" value=\"" + "0x" + uint(this.var_190).toString(16) + "\" type=\"" + this._type + "\" />";
               break;
            default:
               _loc1_ = "<var key=\"" + this.var_654 + "\" value=\"" + this.var_190 + "\" type=\"" + this._type + "\" />";
         }
         return _loc1_;
      }
   }
