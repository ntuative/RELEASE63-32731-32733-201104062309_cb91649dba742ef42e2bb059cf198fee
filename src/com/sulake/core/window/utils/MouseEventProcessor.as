package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      public function MouseEventProcessor()
      {
         ...
         {
            var_339 = new Array();
            var_339[0] = MouseCursorType.const_325;
            var_339[1] = MouseCursorType.const_29;
            var_339[2] = MouseCursorType.const_325;
            var_339[3] = MouseCursorType.const_325;
            var_339[4] = MouseCursorType.const_325;
            var_339[5] = MouseCursorType.const_29;
            var_339[6] = MouseCursorType.const_325;
         }
         if(var_291 == null)
         {
            var_291 = new Array();
            var_291[0] = WindowState.const_104;
            var_291[1] = WindowState.const_84;
            var_291[2] = WindowState.const_101;
            var_291[3] = WindowState.const_66;
            var_291[4] = WindowState.const_56;
            var_291[5] = WindowState.const_97;
            var_291[6] = WindowState.const_85;
         }
      }
      ...
      protected static function convertMouseEventType(param1:MouseEvent, param2:IWindow, param3:IWindow) : WindowMouseEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_UP:
               ...
               _loc4_ = !!_loc6_ ? "null" : WindowMouseEvent.const_194;
               break;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_65 = state.var_1304 as WindowController;
         this.var_176 = state.var_1307 as WindowController;
         this.var_164 = state.renderer;
         this.var_877 = state.var_1308;
         eventQueue.begin();
         this.var_706.x = -1;
         this.var_706.y = -1;
         ...
         while(true)
         {
            ...
            if(event.stageX != this.var_706.x || event.stageY != this.var_706.y)
            {
               ...
               array = new Array();
               this.var_83.groupParameterFilteredChildrenUnderPoint(this.var_706,array,WindowParam.const_31);
            }
               ...
               if(child != null && child.visible)
               {
                  ...
                  else if(event.type == MouseEvent.MOUSE_UP || event.type == MouseEvent.CLICK)
                  {
                     if(this.var_65 && !this.var_65.disposed)
                     {
                        ...
                        {
                           this.var_877.mouseEventReceived(event.type,this.var_65);
                        }
                     }
                  }
                  temp = child.parent;
         ...
         state.var_1304 = this.var_65;
         state.var_1307 = this.var_176;
         state.renderer = this.var_164;
         state.var_1308 = this.var_877;
      }
