package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1215:String = "AssetLibraryReady";
      
      public static const const_685:String = "AssetLibraryLoaded";
      
      public static const const_1599:String = "AssetLibraryUnloaded";
      ...
      private static const const_944:String = "param";
      
      private static const TYPE:String = "mimeType";
      
      private static const const_942:String = "library";
      
      private static var var_294:Dictionary;
      
      private static var var_1617:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_486:uint = 0;
      
      private static var var_881:Array = new Array();
      ...
      private var var_882:Boolean = true;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_486;
         this.var_415 = new Dictionary(false);
         this.var_485 = new Dictionary(false);
         ...
         if(_loc5_ != null)
         {
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_944);
                  if(_loc11_.length())
                  {
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_881.splice(var_881.indexOf(this),1);
            --var_486;
            this.var_485 = null;
            this.var_884 = null;
            this.var_152 = null;
      ...
      {
         if(this.var_589 == param1.url && this.var_883)
         {
            if(!this.var_882 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_588);
            }
            this.var_882 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1215));
         }
         else
         {
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in this.var_485)
         {
            _loc2_ = this.var_485[_loc1_];
            _loc2_.assetLoader.dispose();
            delete this.var_485[_loc1_];
         }
         ...
         this.var_883 = false;
         this.var_589 = null;
         dispatchEvent(new Event(AssetLibrary.const_1599));
      }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_485[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1047,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1113,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1140,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_485[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_485[loader.url];
         if(struct == null)
         {
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_485[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         return this.var_152[param1] != null || (this.var_588 != null ? this.var_588[param1] != null : false);
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_1617.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_294.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_294[param1.mimeType] = param1;
         }
         else
         {
            if(this.var_415.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_415[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_294[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
         }
         return AssetTypeDeclaration(this.var_415[param1]);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_294)
            {
               _loc3_ = AssetTypeDeclaration(var_294[_loc4_]);
               if(_loc3_ != null)
               {
         ...
         for(_loc4_ in this.var_415)
         {
            _loc3_ = AssetTypeDeclaration(this.var_415[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_294)
            {
               _loc4_ = AssetTypeDeclaration(var_294[_loc5_]);
               if(_loc4_ != null)
               {
         ...
         for(_loc5_ in this.var_415)
         {
            _loc4_ = AssetTypeDeclaration(this.var_415[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_883 = true;
         dispatchEvent(new Event(AssetLibrary.const_685));
         dispatchEvent(new Event(AssetLibrary.const_1215));
         if(this.var_882)
         {
