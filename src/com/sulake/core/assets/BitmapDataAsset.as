package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      private var var_1606:AssetTypeDeclaration;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_102 is BitmapDataAsset)
         {
            ...
            this.var_1363 = BitmapDataAsset(this.var_102).var_1363;
            this.var_1362 = BitmapDataAsset(this.var_102).var_1362;
            if(this._bitmap != null)
            {
               this.var_102 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1363 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1362 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
