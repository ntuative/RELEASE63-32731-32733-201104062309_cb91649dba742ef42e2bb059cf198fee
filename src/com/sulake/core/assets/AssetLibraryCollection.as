package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_1071:LoaderContext;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         this.var_1071 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         this.var_475 = new AssetLibrary("lib-" + this.var_576++);
      ...
      {
         while(this.var_571.length > 0)
         {
            (this.var_571.pop() as IAssetLibrary).dispose();
         }
      ...
      private function loadEventHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE)
         {
            ...
            _loc4_ = 0;
            while(_loc4_ < this.var_571.length)
            {
               _loc3_ = this.var_571[_loc4_] as IAssetLibrary;
