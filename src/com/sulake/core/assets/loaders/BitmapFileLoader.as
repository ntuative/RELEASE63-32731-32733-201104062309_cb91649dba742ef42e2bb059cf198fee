package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      {
         super();
         this.var_1070 = param2 == null ? "" : param2.url;
         this._type = param1;
         this.var_42 = new Loader();
         this.var_1071 = new LoaderContext();
         this.var_1071.checkPolicyFile = true;
         ...
         {
            this.var_42.load(param2,this.var_1071);
         }
      }
      ...
      {
         this.var_1070 = param1.url;
         var_335 = 0;
         this.var_42.load(param1,this.var_1071);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_335 < var_2879)
            {
               ...
               this.var_42.load(new URLRequest(this.var_1070 + (this.var_1070.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_335),this.var_1071);
               return true;
            }
         }
         return false;
