package com.sulake.core.communication.messages
{
   ...
   public class MessageDataWrapper implements IMessageDataWrapper
   {
      ...
      private var var_1223:IProtocolDecoder;
      ...
      {
         return this.var_1223.readString(this._data);
      }
      
      public function readInteger() : int
      {
         return this.var_1223.readInteger(this._data);
      }
      
      public function readBoolean() : Boolean
      {
         return this.var_1223.readBoolean(this._data);
      }
      
      public function readShort() : Short
      {
         return this.var_1223.readShort(this._data);
      }
