package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1648:int = 10000;
      ...
      private var var_1195:IMessageClassManager;
      
      private var var_323:ICoreCommunicationManager;
      
      private var var_524:IConnectionStateListener;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this._id = param1;
         this.var_323 = param2;
         this.var_523 = new ByteArray();
         this.var_1195 = new MessageClassManager();
         this.var_81 = new Socket();
         this.var_373 = new Timer(const_1648,1);
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         if(this.var_524)
         {
            this.var_524.connectionInit(param1,param2);
         }
         Security.loadPolicyFile("xmlsocket://" + param1 + ":" + param2);
         this.var_373.start();
         this.var_781 = getTimer();
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_1195.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
            this.logConnection("Could not find registered message composer for " + param1);
            return false;
         }
         var _loc5_:ByteArray = this.var_782.encoder.encode(_loc4_,param1.getMessageArray(),param2);
         if(this.var_524)
         {
            this.var_524.messageSent(String(_loc4_),_loc5_.toString());
         }
         if(this.var_1196 != null)
         {
            _loc3_ = this.var_1196.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      {
         this.var_1195.registerMessages(param1);
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_782.getMessages(this.var_523,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               if(this.var_524)
               {
                  this.var_524.messageReceived(String(id),data.toString());
               }
               eventClasses = this.var_1195.getMessageEventClasses(id);
               events = new Array();
            ...
            {
               temp = new ByteArray();
               temp.writeBytes(this.var_523,offset);
               this.var_523 = temp;
               this.logConnection("[SOCKET REST] offset: " + offset + " rest: " + this.var_523.toString());
            }
         }
         catch(e:Error)
         {
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_523.writeByte(this.var_81.readUnsignedByte());
         }
      }
      ...
      private function onConnect(param1:Event) : void
      {
         ...
         this.var_373.stop();
         this.var_1883 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - this.var_781));
      ...
      private function onClose(param1:Event) : void
      {
         ...
         this.var_1883 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - this.var_781));
         dispatchEvent(param1);
      }
      ...
      private function onComplete(param1:Event) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - this.var_781));
         dispatchEvent(param1);
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - this.var_781));
         dispatchEvent(param1);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - this.var_781));
         switch(param1.type)
         {
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - this.var_781));
