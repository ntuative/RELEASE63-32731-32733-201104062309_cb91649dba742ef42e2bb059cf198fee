package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1723:uint = 1;
      
      protected static const const_1720:uint = 2;
      
      protected static const const_1721:uint = 4;
      
      protected static const const_1722:uint = 3;
      ...
      public static const const_1030:Boolean = false;
      
      public static const const_1428:int = 2;
      
      private static var var_914:Array = new Array();
      
      private static var var_737:Array = new Array();
      ...
      protected var var_2869:String = "";
      
      protected var var_2097:int;
      
      protected var var_1315:int;
      
      protected var var_1314:int;
      
      protected var var_2954:uint = 0;
      
      protected var var_2868:Boolean = true;
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1030)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_737[_loc2_] as LibraryLoader;
               if(_loc1_ && (_loc1_.ready || _loc1_.disposed))
               {
                  var_737.splice(_loc2_,1);
               }
               _loc2_--;
            }
            while(var_737.length < const_1428 && false)
            {
               _loc1_ = var_914.shift() as LibraryLoader;
      ...
      {
         return !!this.var_1067 ? uint(this.var_1315 - this.var_2097) : uint(getTimer() - this.var_2097);
      }
      ...
      {
         if(!this.var_1067 && !_disposed && this.var_1314 > 0)
         {
            try
            {
               this.var_42.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_242,const_1597 - this.var_1314);
            if(this.var_2868)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         if(this.var_472 == LibraryLoader.const_1722)
         {
