package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_1654:String = "float";
      
      public static const const_40:String = "Boolean";
      
      public static const const_1507:String = "bool";
      ...
      public static const const_131:String = "Array";
      
      public static const const_260:String = "Map";
      ...
      private static const const_1774:String = "false";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         else
         {
            ...
            else if(_loc5_ == const_260 || _loc5_ == const_131)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_1654:
               return Number(param1);
            case const_40:
               return param1 == const_636 || int(param1) > 0;
            case const_1507:
               return param1 == const_636 || int(param1) > 0;
            case const_149:
               return uint(param1);
            case const_131:
               return param1.split(const_1387);
            default:
