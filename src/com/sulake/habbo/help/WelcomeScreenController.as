package com.sulake.habbo.help
{
   ...
   public class WelcomeScreenController implements IUpdateReceiver
   {
      ...
      {
         return this._notifications[this.var_1535];
      }
      ...
      public function dispose() : void
      {
         if(this.var_142)
         {
            this.var_142.removeUpdateReceiver(this);
            this.var_142.toolbar.events.removeEventListener(HabboToolbarEvent.const_37,this.onToolbarClicked);
            this.var_142.toolbar.events.removeEventListener(HabboToolbarEvent.const_789,this.onToolbarResized);
            this.var_142 = null;
         }
         ...
         {
            this.var_820.stop();
            this.var_820.removeEventListener(TimerEvent.TIMER,this.onReminderTimer);
            this.var_820 = null;
         }
      ...
      public function showWelcomeScreen(param1:Boolean) : void
      {
         ...
         this.var_142.toolbar.events.addEventListener(HabboToolbarEvent.const_37,this.onToolbarClicked);
         this.var_142.toolbar.events.addEventListener(HabboToolbarEvent.const_789,this.onToolbarResized);
         var _loc4_:int = parseInt(this._config.getKey("welcome.screen.delay","5000"));
         this.var_820 = new Timer(_loc4_);
      ...
      public function onReminderTimer(param1:TimerEvent) : void
      {
         ...
         this.var_227.y = this.var_142.toolbar.getIconLocation(this.current.targetIconId) - this._window.height / 2;
         this._window.y = this.var_227.y;
      ...
      {
         var _loc1_:XmlAsset = this.var_142.assets.getAssetByName("welcome_screen_xml") as XmlAsset;
         ...
         var _loc3_:BitmapDataAsset = this.var_142.assets.getAssetByName("welcome_screen_arrow") as BitmapDataAsset;
      ...
      {
         var _loc2_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_89,this.current.targetIconId);
         _loc2_.iconState = !!param1 ? "highlight_blue" : "0";
         this.var_142.toolbar.events.dispatchEvent(_loc2_);
      }
      ...
      private function closeWindow() : void
      {
         ...
         if(this.var_1535 < this._notifications.length - 1)
         {
            ++this.var_1535;
         }
         else
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:Number = Point.distance(this._window.rectangle.topLeft,this.var_227);
         if(_loc2_ > 5)
         {
            _loc3_ = Point.interpolate(this._window.rectangle.topLeft,this.var_227,0.5);
            this._window.x = _loc3_.x;
            this._window.y = _loc3_.y;
         }
         else
         {
            this._window.x = this.var_227.x;
            this._window.y = this.var_227.y;
            this.var_142.removeUpdateReceiver(this);
         }
      }
      ...
      {
         this.var_142.removeUpdateReceiver(this);
         this.var_142.registerUpdateReceiver(this,10);
      }
   }
}
