   ...
   public class IncomingMessages
   {
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            {
               this.var_2207 = _loc5_.id;
            }
            _loc4_++;
         }
         this.var_22.tellUI(HabboHelpViewEnum.const_771);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         this.var_22.tellUI(HabboHelpViewEnum.const_192);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            _loc9_ = _loc3_.method_5(_loc6_,_loc8_,true);
            _loc9_.itemCount = _loc7_.getValue("count");
            _loc5_++;
         }
         this.var_22.showUI(HabboHelpViewEnum.const_502);
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         var _loc6_:FaqCategory = _loc3_.method_5(_loc5_);
         if(_loc6_ == null)
         {
            return;
         }
         ...
         this.var_22.tellUI(HabboHelpViewEnum.const_307,_loc6_);
      }
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            this.var_22.tellUI(HabboHelpViewEnum.const_240,_loc4_);
         }
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         this.var_22.showUI(HabboHelpViewEnum.const_1127);
         this.var_22.tellUI(HabboHelpViewEnum.const_1127,_loc5_);
      }
