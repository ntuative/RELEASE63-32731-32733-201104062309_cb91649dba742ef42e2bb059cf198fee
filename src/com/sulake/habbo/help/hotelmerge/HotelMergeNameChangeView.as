package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_756)
         {
            this.var_756 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_756)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_755)
         {
            this.var_755 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_755)
            {
               return;
            }
