package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_419:String = "TUI_CLOTHES_VIEW";
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_33.events.addEventListener(HabboHelpTutorialEvent.const_465,this.onTaskDoneEvent);
         this.var_33.events.addEventListener(HabboHelpTutorialEvent.const_576,this.onTaskDoneEvent);
         this.var_33.events.addEventListener(HabboHelpTutorialEvent.const_456,this.onTaskDoneEvent);
         if(this.var_33.sessionDataManager != null)
         {
            this.var_33.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_318,this.onFigureUpdate);
         }
      }
      ...
      {
         return this.var_1194 && this.var_1193 && this.var_1474;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_33)
         {
            this.var_33.events.removeEventListener(HabboHelpTutorialEvent.const_465,this.onTaskDoneEvent);
            this.var_33.events.removeEventListener(HabboHelpTutorialEvent.const_576,this.onTaskDoneEvent);
            this.var_33.events.removeEventListener(HabboHelpTutorialEvent.const_456,this.onTaskDoneEvent);
            if(this.var_33.sessionDataManager != null)
            {
               this.var_33.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_318,this.onFigureUpdate);
            }
            this.var_33 = null;
         }
      }
      ...
      public function update(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         if(this.var_44 == null || this.var_44.id == const_94)
         {
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_465:
               this.var_1474 = true;
               if(this.var_44 != null && this.var_44.id == const_580)
               {
                  this.showView(const_94);
               }
               break;
            case HabboHelpTutorialEvent.const_576:
               if(this.var_44 != null && this.var_44.id == const_419)
               {
                  this.var_1880 = true;
                  this.disposeWindow();
               }
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2341 = this._window.width - _loc2_.width;
         ...
         this._window.height = _loc2_.height + this.var_2342;
         this._window.width = _loc2_.width + this.var_2341;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_44 != null && (this.var_44.id == const_342 || this.var_44.id == const_94))
         {
            this.showView(const_94);
         }
      }
      ...
      {
         this.var_1194 = true;
         if(this.var_44 != null && (this.var_44.id == const_419 || this.var_44.id == const_94))
         {
            this.showView(const_94);
         }
      }
