package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_858:FaqCategory;
      
      private var var_857:FaqCategory;
      
      private var var_856:FaqCategory;
      ...
      {
         super();
         this.var_858 = new FaqCategory(-999,"${help.faq.title.urgent}");
         this.var_857 = new FaqCategory(-9999,"${help.faq.title.normal}");
         this.var_856 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
      ...
      public function method_5(param1:int, param2:String = null, param3:Boolean = false) : FaqCategory
      {
      ...
      public function getItem(param1:int, param2:int = -1) : FaqItem
      {
         ...
         var _loc3_:FaqCategory = this.method_5(param2);
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      {
         var _loc4_:* = null;
         if(this.var_858.hasItem(param1))
         {
            this.var_858.getItem(param1).answerText = param2;
         }
         if(this.var_857.hasItem(param1))
         {
            this.var_857.getItem(param1).answerText = param2;
         }
         if(this.var_856.hasItem(param1))
         {
            this.var_856.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(this.var_858.hasItem(param1))
         {
            return this.var_858.getItem(param1);
         }
         if(this.var_857.hasItem(param1))
         {
            return this.var_857.getItem(param1);
         }
         if(this.var_856.hasItem(param1))
         {
            return this.var_856.getItem(param1);
         }
         var _loc2_:int = 0;
