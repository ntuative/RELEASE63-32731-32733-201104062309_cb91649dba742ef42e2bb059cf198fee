package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1156:BitmapData = null;
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2451 = this._config.getKey("interstitial.enabled","false") == "true";
         this.var_2452 = int(this._config.getKey("interstitial.interval","30000"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_1155 == 0)
         {
            this.var_1155 = getTimer();
            return false;
         }
         if(this.var_1801 > 0 && this.var_1803 >= this.var_1801)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1155;
         if(_loc1_ > this.var_2452)
         {
            ++this.var_1803;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1431 = _loc2_.imageUrl;
         this.var_2450 = _loc2_.clickUrl;
         this.var_1155 = getTimer();
         if(this.var_1431 != "")
         {
            _loc3_ = this.var_1431;
            ...
            {
               this.var_224 = new Timer(this.var_2453,1);
            ...
            this.var_224.start();
            _loc4_ = new URLRequest(this.var_1431);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_594,0,0,param1.bitmapData,this.var_2450));
            this.var_1155 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_494));
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1430 = _loc2_.imageUrl;
         this.var_1802 = _loc2_.clickUrl;
         if(this.var_1430 != "" && this.var_1802 != "")
         {
            _loc3_ = this.var_1430;
            if(assets.hasAsset(_loc3_))
            {
               assets.removeAsset(assets.getAssetByName(_loc3_));
            }
            _loc4_ = new URLRequest(this.var_1430);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_540,0,0,_loc4_,_loc2_.assetName,this.var_1802,this.var_1156,this.var_1157));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1156 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function loadImageAsset(param1:AdImageEvent) : void
      {
         ...
         var _loc3_:Array = this.var_629.getValue(_loc2_);
         if(_loc3_ == null)
         {
            _loc3_ = new Array();
            this.var_629.add(_loc2_,_loc3_);
         }
         if(_loc3_.length > 0)
         {
      ...
      private function onBillboardImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc2_:AssetLoaderStruct = param1.target as AssetLoaderStruct;
         var _loc3_:Bitmap = _loc2_.assetLoader.content as Bitmap;
         var _loc4_:Array = this.var_629.remove(_loc2_.assetName);
      ...
      private function dispatchImageAsset(param1:BitmapData, param2:AdImageEvent) : void
      {
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_643,param2.roomId,0,param1.clone(),param2.imageUrl,param2.clickUrl,null,null,param2.objectId));
         }
      }
      ...
      private function onBillboardImageLoadError(param1:AssetLoaderEvent) : void
      {
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_713,_loc5_.roomId,0,null,_loc5_.imageUrl,_loc5_.clickUrl,null,null,_loc5_.objectId));
         }
      }
   }
}
