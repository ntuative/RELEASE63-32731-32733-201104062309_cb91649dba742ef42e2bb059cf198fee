package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1700 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1115 = this.var_1700.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1115)
         {
            this.var_1115.procedure = this.onButtonClick;
         }
         this.var_1114 = this.var_1700.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1114)
         {
            this.var_1114.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_249 >= this.var_67.length - 1)
         {
            this.var_1114.disable();
         }
         else
         {
            this.var_1114.enable();
         }
         if(this.var_249 <= 0)
         {
            this.var_1115.disable();
         }
         else
         {
            this.var_1115.enable();
         }
      }
      ...
      {
         ++this.var_249;
         this.var_249 = Math.min(this.var_249,this.var_67.length - 1);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_67[this.var_249][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_67[this.var_249][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_67[this.var_249][1]).value;
