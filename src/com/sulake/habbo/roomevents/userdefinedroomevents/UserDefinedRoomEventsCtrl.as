package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private var var_1830:TriggerConfs;
      
      private var var_1829:ActionTypes;
      
      private var var_1828:ConditionTypes;
      
      private var var_261:Dictionary;
      
      private var var_35:Triggerable;
      
      private var var_769:RoomObjectHightLighter;
      
      private var var_142:UserDefinedRoomEventsHelp;
      
      private var var_1168:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1830 = new TriggerConfs();
         this.var_1829 = new ActionTypes();
         this.var_1828 = new ConditionTypes();
         this.var_261 = new Dictionary();
         super();
         this.var_80 = param1;
         this.var_769 = new RoomObjectHightLighter(param1);
         this.var_142 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1168 = new SliderWindowController(this.var_80,IWindowContainer(this.find(this.var_51,"delay_slider_container")),this.var_80.assets,0,20,1);
         this.var_1168.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1168.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_769.hideAll(this.var_261);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_769.showAll(this.var_261);
         if(this.var_35 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_35);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1168.setValue(_loc6_);
         }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1168.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_142.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.stuffTypeSelectionCode = this.var_35.stuffTypeSelectionCode < 1 ? int(var_1443) : int(this.var_35.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.stuffTypeSelectionCode = (this.var_35.stuffTypeSelectionCode + 1) % (var_1443 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1830);
         this.refreshConfigureElement(this.var_1829);
         this.refreshConfigureElement(this.var_1828);
