package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputWidget extends RoomWidgetBase
   {
      ...
      private static const const_1246:int = 5000;
      ...
      private var var_413:Timer = null;
      ...
      {
         return getTimer() - this.var_2132 > const_1246;
      }
      ...
      public function sendChat(param1:String, param2:int, param3:String = "") : void
      {
         ...
         var _loc4_:RoomWidgetChatMessage = new RoomWidgetChatMessage(RoomWidgetChatMessage.const_706,param1,param2,param3);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChatInputContentUpdateEvent.const_840,this.onChatInputUpdate);
         param1.addEventListener(RoomWidgetUserInfoUpdateEvent.const_142,this.onUserInfo);
         param1.addEventListener(RoomWidgetFloodControlEvent.const_930,this.onFloodControl);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChatInputContentUpdateEvent.const_840,this.onChatInputUpdate);
         param1.removeEventListener(RoomWidgetUserInfoUpdateEvent.const_142,this.onUserInfo);
         param1.removeEventListener(RoomWidgetFloodControlEvent.const_930,this.onFloodControl);
      }
      ...
      private function onChatInputUpdate(param1:RoomWidgetChatInputContentUpdateEvent) : void
      {
         ...
         switch(param1.messageType)
         {
            case RoomWidgetChatInputContentUpdateEvent.const_1172:
               ...
               break;
            case RoomWidgetChatInputContentUpdateEvent.const_1454:
         }
      }
      ...
      private function refreshWindowPosition() : void
      {
         ...
         var _loc1_:RoomWidgetChatInputWidgetMessage = new RoomWidgetChatInputWidgetMessage(RoomWidgetChatInputWidgetMessage.const_927,this._visualization.window);
         if(messageListener != null)
         {
      ...
      private function onReleaseTimerTick(param1:TimerEvent) : void
      {
         if(this._visualization != null)
         {
            ...
            this._visualization.showFloodBlocking(this.var_709);
         }
      }
      ...
      {
         this.var_1331 = true;
         this.var_709 = param1.seconds;
         Logger.log("Enabling flood blocking for " + this.var_709 + " seconds");
         if(this.var_413)
         {
            this.var_413.reset();
         }
         ...
         {
            this.var_413 = new Timer(1000,this.var_709);
            this.var_413.addEventListener(TimerEvent.TIMER,this.onReleaseTimerTick);
            this.var_413.addEventListener(TimerEvent.TIMER_COMPLETE,this.onReleaseTimerComplete);
         }
         this.var_413.start();
         if(this._visualization != null)
         {
