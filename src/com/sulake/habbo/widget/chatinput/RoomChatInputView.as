package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1293:int = 11;
      
      private static const const_612:int = 18;
      
      private static const const_958:int = 16;
      
      private static const const_1294:int = 20;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         this.var_2419 = this._localization.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_361 = new Timer(1000,1);
         this.var_361.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_437 = new Timer(10000,1);
         this.var_437.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_437.reset();
            this.var_437.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
            this.var_437 = null;
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         _loc6_.addEventListener(WindowEvent.const_110,this.onInputChanged);
      ...
      private function refreshView() : void
      {
         ...
         this._window.width = _loc1_.width + const_612 + const_958;
         _loc1_.x = const_612;
         _loc1_.y = const_1293;
      }
      ...
      {
         this.var_300 = param1 - (const_612 + const_958);
      ...
      private function onWindowMoved(param1:WindowEvent) : void
      {
         ...
         this.setMaxWidth(this._window.context.getDesktopWindow().width - this._window.x - const_1294);
      }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(_loc2_.text.length > this.var_507.length + 1)
            {
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_622);
