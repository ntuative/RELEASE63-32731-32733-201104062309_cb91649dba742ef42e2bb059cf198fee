package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_1048:MeMenuSoundSettingsSlider;
      ...
      {
         this.var_527 = param1.volume;
         if(this.var_1048 != null)
         {
            this.var_1048.setValue(this.var_527);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_2043 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_off_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_2041 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_color") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_2042 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_2044 = (_loc5_.content as BitmapData).clone();
         }
         this.var_1048 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.setSoundsOffIcon();
         this.setSoundsOnIcon();
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_883));
      }
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_527 == 0)
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_2043);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_2041);
         }
      }
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_527 == 1)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_2042);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_2044);
         }
      }
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_683);
         }
         else
         {
