package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_2042:int = 1000;
      ...
      private var var_1019:IWindow;
      
      public function EffectView()
      {
         super();
         this.var_215 = new Timer(this.const_2042);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_192.isActive)
         {
            ...
            this.var_1020.width = _loc2_ * this.var_300;
         }
         else
         {
            this.var_1020.width = 0;
            this.var_215.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            this.var_1019 = this._window.findChildByName("effect_hilite");
            this.var_1019.visible = false;
         }
         this.setTimeLeft();
         this.var_1020 = this._window.findChildByName("loader_bar");
         if(this.var_1020 != null)
         {
            this.var_300 = this.var_1020.width;
            this.var_215.start();
            this.onUpdate();
         }
