package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      protected var var_52:IBorderWindow;
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         this.var_241 = this.var_52.findChildByTag("catalog");
      ...
      {
         if(this._widget == null || this.var_52 == null)
         {
            return;
         }
         var _loc2_:IWindow = this.var_52.findChildByName("furni_details_spacer");
         if(_loc2_ != null)
         {
            _loc2_.visible = param1;
         }
         var _loc3_:IWindow = this.var_52.findChildByName("furni_details_text") as ITextWindow;
         if(_loc3_ != null)
         {
      ...
      private function showCatalogButton(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_53.addListItem(this.var_241);
            }
            this.var_241.visible = param1;
         }
         else
         {
            this.var_53.removeListItem(this.var_241);
         }
      }
   }
}
