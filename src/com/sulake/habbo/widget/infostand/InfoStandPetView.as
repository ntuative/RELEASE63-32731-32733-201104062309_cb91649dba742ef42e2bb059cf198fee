package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_2016:int = 152;
      
      private const const_2022:int = 16;
      
      private const const_1298:int = 4;
      
      private const const_2023:uint = 14342874;
      
      private const const_2026:uint = 3815994;
      
      private const const_2020:uint = 2085362;
      
      private const const_2018:uint = 39616;
      
      private const const_2015:uint = 10513106;
      
      private const const_2014:uint = 8734654;
      
      private const const_2019:uint = 9094430;
      
      private const const_2017:uint = 6200576;
      
      private const const_2021:String = "happiness";
      
      private const const_2025:String = "experience";
      
      private const const_2024:String = "energy";
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_2021,param1.nutrition,param1.nutritionMax,this.const_2018,this.const_2020);
         this.updateStateElement(this.const_2025,param1.experience,param1.experienceMax,this.const_2014,this.const_2015);
         this.updateStateElement(this.const_2024,param1.energy,param1.energyMax,this.const_2017,this.const_2019);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(this.const_2016,this.const_2022,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),this.const_2023);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,this.const_2026);
         var _loc9_:Rectangle = new Rectangle(1,1 + this.const_1298,_loc7_.width - 2,_loc7_.height - 2 - this.const_1298);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,this.const_1298);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_481) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_204 && this.var_204.getPetId() == this.var_481)
               {
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1477,true);
