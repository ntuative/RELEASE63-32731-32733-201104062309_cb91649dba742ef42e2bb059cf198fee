package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_2031:int = 5;
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(this.var_1153 + param1.height > this.var_1154.height)
         {
            return false;
         }
         ...
         {
            this._offsetX = 0;
            this.var_1153 += param1.height + this.const_2031;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1153);
