package com.sulake.habbo.widget.furniture.stickie
{
   ...
   public class StickieFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1245:Number = 100;
      ...
      private function onObjectUpdate(param1:RoomWidgetStickieDataUpdateEvent) : void
      {
         ...
         this.var_2018 = param1.objectType;
         this._text = param1.text;
         this.var_1041 = param1.colorHex;
      ...
      private function showInterface() : void
      {
         ...
         {
            this._window = windowManager.createWindow("stickieui_container","",HabboWindowType.const_69,HabboWindowStyle.const_29,0 | 0,new Rectangle(const_1245,WINDOW_INITIAL_Y,2,2),null,0) as IWindowContainer;
         ...
         if(_loc6_ != null)
         {
            ...
            else
            {
               ...
               _loc6_.color = uint("0xFF" + this.var_1041);
            }
         ...
         this.setColorButtons(this._controller && this.var_2018 == "post_it");
      }
      ...
      private function sendUpdate() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_448,this.var_378,this._text,this.var_1041);
      ...
      private function sendSetColor(param1:uint) : void
      {
         ...
         if(messageListener != null)
         {
            _loc3_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_448,this.var_378,this._text,this.var_1041);
      ...
      private function sendDelete() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_924,this.var_378);
            messageListener.processWidgetMessage(_loc1_);
         }
      }
