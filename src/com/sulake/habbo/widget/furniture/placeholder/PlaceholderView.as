package com.sulake.habbo.widget.furniture.placeholder
{
   ...
   public class PlaceholderView
   {
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._windowManager.createWindow("habbohelp_window","",HabboWindowType.const_69,HabboWindowStyle.const_43,0 | 0,new Rectangle(-300,300,10,10),null) as IWindowContainer;
