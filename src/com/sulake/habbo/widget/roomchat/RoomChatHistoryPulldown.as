package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      private static const const_935:int = 150;
      
      private static const const_936:int = 250;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_41 = param3;
         this.var_2138 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_1599 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2134 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1600 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1598 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2137 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2135 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_74 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_304,HabboWindowStyle.const_29,HabboWindowParam.const_62,new Rectangle(0,0,param3.width,param3.height - const_87),null,0,0) as IBitmapWrapperWindow;
         this.var_41.addChild(this.var_74);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_69,HabboWindowStyle.const_29,0 | 0,new Rectangle(0,this.var_41.height - const_87,param3.width,const_87),null,0) as IWindowContainer;
         this.var_41.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_579,HabboWindowStyle.const_43,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_87),null,0) as IRegionWindow;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_454:
               this.var_74.blend += param1 / const_936;
               this._window.blend += param1 / const_936;
               ...
               break;
            case const_946:
               this.var_74.blend -= param1 / const_935;
               this._window.blend -= param1 / const_935;
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         {
            this._window.x = 0;
            this._window.y = this.var_41.height - const_87;
            this._window.width = this.var_41.width;
         }
         if(this._region != null)
         {
            this._region.x = 0;
            this._region.y = this.var_41.height - const_87;
            this._region.width = this.var_41.width - this.var_2136;
         }
         if(this.var_74 != null)
         {
            this.var_74.rectangle = this.var_41.rectangle;
            this.var_74.height -= const_87;
         }
         this.buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2139 == this._window.width)
         {
            return;
         }
         this.var_2139 = this._window.width;
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_2138,_loc7_);
            ...
            if(_loc3_.width > 0 && _loc3_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1599,_loc8_);
            ...
            if(_loc4_.width > 0 && _loc4_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1599,_loc9_);
         ...
         this.var_74.bitmap = this.var_2135;
