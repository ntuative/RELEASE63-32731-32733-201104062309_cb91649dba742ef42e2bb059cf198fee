package com.sulake.habbo.widget.chooser
{
   ...
   public class ChooserView
   {
      ...
      private const const_1766:uint = 0;
      
      private const const_2040:uint = 4.282169599E9;
      ...
      public function populate(param1:Array, param2:Boolean) : void
      {
         ...
         while(_loc6_ < param1.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc5_.color = !!(_loc6_ % 2) ? uint(this.const_1766) : uint(this.const_1767);
      ...
      {
         var _loc2_:* = null;
         if(this._itemList == null || param1 < 0 || param1 > this._itemList.numListItems || param1 == this.var_991)
         {
            return;
         }
         if(this.var_991 != -1)
         {
            _loc2_ = this._itemList.getListItemAt(this.var_991) as IWindowContainer;
            if(_loc2_ != null)
            {
               _loc2_.color = !!(this.var_991 % 2) ? uint(this.const_1766) : uint(this.const_1767);
            }
         }
         _loc2_ = this._itemList.getListItemAt(param1) as IWindowContainer;
         if(_loc2_ != null)
         {
            _loc2_.color = this.const_2040;
            this.var_991 = param1;
         }
      }
