package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_586:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_153.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_146,HabboWindowStyle.const_43,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1734,"/");
         if(_loc5_ != null)
         {
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1734,"/");
         ...
         {
            dispatchEvent(new Event(const_586));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_128.removeEventListener(SSOTicket.const_382,this.onParsedTicketSuccess);
            this.var_128.removeEventListener(SSOTicket.const_337,this.onParsedTicketFailure);
            this.var_128 = null;
         }
         var _loc2_:String = "";
         if(this.var_153.habboConfiguration != null)
         {
            _loc2_ = this.var_153.habboConfiguration.getKey("url.prefix",_loc2_);
            _loc2_ = _loc2_.replace("http://","");
            _loc2_ = _loc2_.replace("https://","");
         }
         var _loc3_:IHabboWebLogin = this.var_153.habboCommunication.habboWebLogin(this.name,this.password);
         this.var_128 = new SSOTicket(this.var_153.assets,_loc3_,_loc2_,param1);
         this.var_128.addEventListener(SSOTicket.const_382,this.onParsedTicketSuccess);
         this.var_128.addEventListener(SSOTicket.const_337,this.onParsedTicketFailure);
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         {
            this.var_153.habboConfiguration.setKey("facebook.user","1");
         }
         this.var_153.flashClientUrl = this.var_128.flashClientUrl;
         this.var_153.ssoTicket = this.var_128.ticket;
         this.var_128.removeEventListener(SSOTicket.const_382,this.onParsedTicketSuccess);
         this.var_128.removeEventListener(SSOTicket.const_337,this.onParsedTicketFailure);
         this.var_128 = null;
         dispatchEvent(new Event(const_586));
