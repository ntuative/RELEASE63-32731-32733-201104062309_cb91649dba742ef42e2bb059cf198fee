package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_970:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1335:String = "sendAccessTokenToServer";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1335,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1334,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_970);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_970);
         }
      }
