package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2036:String = "hd-99999-99999";
      ...
      private var var_1889:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_600 = RenderMode.const_1563;
         ...
         this.var_105.add(AvatarType.const_124,_loc4_);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_311.init();
         this.var_785.init();
         _loc2_ = this.var_105.getValue(AvatarType.const_124) as AvatarStructure;
         if(_loc2_)
         {
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_105.getValue(AvatarType.const_124) as AvatarStructure;
            if(_loc3_ != null)
            {
      ...
      {
         var _loc5_:AvatarStructure = this.var_105.getValue(AvatarType.const_124) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_1889)
         {
            this.var_1889 = new AvatarFigureContainer(this.const_2036);
         }
         this.var_229.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1889,param2);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1681)
         {
      ...
      {
         var _loc3_:AvatarStructure = this.var_105.getValue(AvatarType.const_124) as AvatarStructure;
