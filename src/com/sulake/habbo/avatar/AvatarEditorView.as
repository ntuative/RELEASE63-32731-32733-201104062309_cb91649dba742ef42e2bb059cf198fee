package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1306:IWindowContainer;
      ...
      private var var_376:ITabSelectorWindow;
      
      private var _catalog:IHabboCatalog;
      
      private var var_526:IFrameWindow;
      ...
      private var var_2608:Boolean = true;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1208 = [];
         this.var_1387 = [AvatarEditorFigureCategory.const_913,AvatarEditorFigureCategory.const_52,AvatarEditorFigureCategory.const_242,AvatarEditorFigureCategory.const_690,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_109];
         super();
         ...
         if(var_1306 == null)
         {
            ...
            var_1306 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1583 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1583 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_448 = new Timer(1000);
         this.var_448.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_448.stop();
            this.var_448.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_448 = null;
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2609 = this.canChangeOutfit();
            this.var_448.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_376 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_376.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_376.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1208.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_376.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_376.numSelectables)
               {
                  this.var_376.getSelectableAt(_loc6_).x = this.var_376.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
         }
         this.var_376.setSelected(this.var_376.getSelectableAt(0));
         this.attachImages();
         this.update();
      }
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_45) && (this.var_1893 == AvatarEditorSideCategory.const_109 || this.var_2608))
         {
      ...
      {
         if(this.var_1893 == AvatarEditorSideCategory.const_109)
         {
            this.var_2608 = false;
            this.setSideContent(AvatarEditorSideCategory.const_705);
         }
         else
         {
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_355 = param1;
         this.var_376.setSelected(this.var_376.getSelectableByName(param1));
      }
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "save":
                  ...
                  this.var_2377 = new Date().valueOf();
                  this.var_2609 = false;
                  this.var_448.start();
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_526)
         {
            ...
            this.var_526 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_526.procedure = this.stripClubDialogEventProc;
            this.var_526.center();
         }
         else
         {
      ...
      private function canChangeOutfit() : Boolean
      {
         ...
         return _loc1_ - this.var_2377 > 5000;
      }
   }
}
