package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(this.var_1045 >= 0 && this._parts.length > this.var_1045)
         {
            _loc2_ = this._parts[this.var_1045];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
      ...
      {
         return this._parts[this.var_1045] as AvatarEditorGridPartItem;
      }
