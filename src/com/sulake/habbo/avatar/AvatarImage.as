package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1346:String = "Default";
      
      private static const const_1347:int = 2;
      
      private static const const_1348:String = AvatarSetType.const_36;
      ...
      protected var var_640:AvatarFigureContainer;
      ...
      private var var_1027:IActiveActionData;
      ...
      private var var_2668:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1348,const_1347);
         this.var_336 = new Array();
         this.var_1027 = new ActiveActionData(AvatarAction.const_380);
         this.var_1027.definition = this._structure.getActionDefinition(const_1346);
         this.resetActions();
      ...
      {
         return this._structure.getPartColor(this.var_640,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         param2 += this.var_1933;
         if(param2 < AvatarDirectionAngle.const_1173)
         {
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_657,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_270.length == 1 && this.var_89 == this.var_2032)
         {
            return this.var_89 + this.var_531 + this.var_657 % 4;
         }
         if(this.var_270.length == 2)
         {
            for each(_loc1_ in this.var_270)
            {
               ...
               {
                  return this.var_89 + this.var_531 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_657 % 11;
                  return this.var_89 + "_" + this.var_2032 + this.var_531 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2667 || param2 != this.var_2668 || param1 != this.var_2666)
         {
            this.var_2667 = param3;
            this.var_2668 = param2;
            this.var_2666 = param1;
            this.var_1932 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1323 || this.var_46 == null || (this.var_46.width != _loc5_.width || this.var_46.height != _loc5_.height))
         {
            if(this.var_46 != null && !this.var_1323)
            {
               this.var_46.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_288.definition.geometryType,this.var_89);
         this.var_46.lock();
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_657);
         ...
         if(this.var_575 != null)
         {
            if(this.var_575.paletteIsGrayscale)
            {
               ...
               this.var_46 = _loc13_;
               this.var_46.paletteMap(this.var_46,this.var_46.rect,new Point(0,0),this.var_575.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_288.definition.geometryType,this.var_89);
         var _loc11_:Rectangle = new Rectangle();
         var _loc12_:int = _loc5_.length - 1;
         while(_loc12_ >= 0)
         {
            _loc7_ = _loc5_[_loc12_];
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_657);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_336.push(new ActiveActionData(param1,param2,this.var_657));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_288 = this.var_1027;
         this.var_288.definition = this.var_1027.definition;
         this.resetBodyPartCache(this.var_1027);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_531 = "";
         this.var_270 = this._structure.sortActions(this.var_336);
         if(this.var_270 == null)
         {
            this.var_749 = new Array(0,0,0);
            if(this.var_1499 != "")
            {
               _loc1_ = true;
               this.var_1499 = "";
         ...
         {
            this.var_749 = this._structure.getCanvasOffsets(this.var_270,this._scale,this.var_89);
            for each(_loc4_ in this.var_270)
            {
               this.var_531 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_339)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1498 != _loc5_)
                  {
                     _loc2_ = true;
                  }
            ...
            if(this.var_1499 != this.var_531)
            {
               _loc1_ = true;
               this.var_1499 = this.var_531;
            }
         }
         this.var_1500 = true;
         return _loc1_;
            ...
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.definition.isAnimation)
               {
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1933 = _loc2_.directionData.offset;
                     }
               ...
               if(_loc1_.actionType == AvatarAction.const_314 || _loc1_.actionType == AvatarAction.const_271 || _loc1_.actionType == AvatarAction.const_384)
               {
                  this.var_1028 = true;
               }
            }
