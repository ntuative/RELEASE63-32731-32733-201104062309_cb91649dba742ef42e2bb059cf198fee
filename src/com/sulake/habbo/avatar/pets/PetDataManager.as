package com.sulake.habbo.avatar.pets
{
   ...
   public class PetDataManager implements IPetDataManager, IDisposable
   {
      ...
      {
         if(param1 == null || this.var_493 == null)
         {
            return;
         }
      ...
      {
         var _loc1_:* = null;
         while(this.var_493.length > 0)
         {
            _loc1_ = this.var_493.pop() as IPetDataListener;
            ...
            if(petData != null)
            {
               ...
               for each(breed in petData.breeds)
               {
                  ...
                  for each(targetSetName in targetSets)
                  {
                     ...
                     {
                        figurePart = figureTargetSet.var_2152.part.(@id == petData.species).(hasOwnProperty("palettemapid") && @palettemapid == breed.patternId)[0];
                        if(figurePart == null)
                        {
                        }
      ...
      public function assetsReady(param1:int, param2:String, param3:IPetDataListener = null) : Boolean
      {
         ...
         {
            if(this.var_1359.indexOf(_loc6_) == -1)
            {
               _loc7_ = false;
               if(this.var_603.getValue(_loc6_) == null)
               {
                  ...
                  if(param3 != null && this.var_493.indexOf(param3) == -1)
                  {
                     this.var_493.push(param3);
                  }
               }
            }
         }
