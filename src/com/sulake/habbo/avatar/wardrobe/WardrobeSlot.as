package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit, IAvatarImageListener
   {
      ...
      public function updateView() : void
      {
         ...
         if(this.var_640 && this.var_1452)
         {
            _loc5_ = this._controller.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_90,this.var_968,this);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_36,parseInt(FigureData.const_773));
         ...
         if(_loc4_)
         {
            _loc4_.visible = this.var_1452 && this.var_640 != null;
         }
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "set_button":
               this.var_640 = this._controller.figureData.getFigureString();
               this.var_968 = this._controller.gender;
               this._controller.handler.saveWardrobeOutfit(this.var_1852,this);
               this.updateView();
               break;
            case "get_button":
               if(this.var_640)
               {
                  this._controller.loadAvatarInEditor(this.var_640,this.var_968,this._controller.clubMemberLevel);
               }
         }
      }
