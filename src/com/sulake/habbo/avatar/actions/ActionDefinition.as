package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_2406 = parseInt(param1.@precedence);
         this.var_2402 = String(param1.@activepartset);
         this.var_2405 = String(param1.@assetpartdefinition);
         this.var_2400 = String(param1.@lay);
         this.var_717 = String(param1.@geometrytype);
         this.var_2401 = Boolean(parseInt(param1.@main));
         this.var_2403 = Boolean(parseInt(param1.@method_3));
         this.var_2404 = Boolean(parseInt(param1.@animation));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "default")
            {
               this.var_2407 = _loc6_;
            }
            else
            {
               this.var_1753[_loc5_] = _loc6_;
            }
         }
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         {
            this.var_749.add(param1,new Map());
         }
         var _loc4_:Map = this.var_749.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = this.var_749.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1753[param1];
         if(_loc2_ == null)
         {
            _loc2_ = this.var_2407;
         }
         return _loc2_;
      }
