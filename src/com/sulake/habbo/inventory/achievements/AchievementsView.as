package com.sulake.habbo.inventory.achievements
{
   ...
   public class AchievementsView implements IInventoryView
   {
      ...
      public function AchievementsView(param1:AchievementsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:ISessionDataManager)
      {
         ...
         this.var_465.addEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
         this.var_305.events.addEventListener(BadgeImageReadyEvent.const_128,this.onBadgeImageReady);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_465)
            {
               this.var_465.removeEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
               this.var_465.reset();
               this.var_465 = null;
            }
            this._disposed = true;
      ...
      {
         Logger.log("Got badge: " + param1.badgeId + ", " + this.var_465.running);
         this.var_1267[param1.badgeId] = param1.badgeImage;
      ...
      private function refreshBadgeImage(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc4_:BitmapData = this.var_1267[param2.badgeId];
         if(_loc4_ == null)
         {
            _loc4_ = this.var_305.getBadgeImage(param2.badgeId);
            this.var_1267[param2.badgeId] = _loc4_;
         }
