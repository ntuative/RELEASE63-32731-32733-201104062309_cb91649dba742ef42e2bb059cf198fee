package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_871:int = 0;
      
      protected var var_699:BitmapData;
      
      protected var var_2423:int;
      
      protected var var_1589:Boolean;
      
      protected var var_2099:Boolean;
      
      protected var var_2875:BitmapData;
      
      private const const_2010:int = 8947848;
      
      private const const_2009:int = 13421772;
      
      private const const_1762:Number = 1;
      
      private const const_1761:Number = 0.2;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2876 == FurniModel.const_46)
         {
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_877)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1761;
               _loc1_.blend = this.const_1761;
            }
            else
            {
               this._window.blend = this.const_1762;
               _loc1_.blend = this.const_1762;
            }
         }
         if(this.isSelected)
         {
