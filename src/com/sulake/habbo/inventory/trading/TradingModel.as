package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1524:uint = 9;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_1175 = false;
         this.var_1635 = param6;
         this.var_775 = true;
         this.state = const_211;
         this.var_56.setup(param1,param3,param4,param6);
         this.var_56.updateItemList(this.var_773);
         this.var_56.updateItemList(this.var_1447);
      ...
      public function close() : void
      {
         if(this.var_775)
         {
            if(this._state != const_187 && this._state != const_270)
            {
      ...
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_772 + " OTHER: " + this.var_1175);
         ...
         {
            case const_187:
               if(param1 == const_211 || param1 == const_270)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         else if(param1 is TradingAcceptEvent)
         {
            ...
            {
               this.var_772 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1175 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_56.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            {
               this.var_56.alertPopup(TradingView.const_1090);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_263.length < const_1524)
         {
         ...
         else
         {
            ...
            if(param3 == FurniCategory.const_199)
            {
