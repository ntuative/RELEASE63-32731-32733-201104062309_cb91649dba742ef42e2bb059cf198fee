package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1014:uint = 4284532064;
      
      private static const const_1015:uint = 2577770;
      ...
      private var var_1056:GroupItem;
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_2054 = this.createMinimizedWindow();
         }
         if(!this.var_2859)
         {
            return this.var_72;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_72)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_18.ownUserAccepts ? uint(const_1014) : uint(const_1015);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_18.otherUserAccepts ? uint(const_1014) : uint(const_1015);
            }
      ...
      public function removeSelection() : void
      {
         if(this.var_1056)
         {
            this.var_1056.isSelected = false;
            this.var_1056 = null;
         }
      }
               ...
               case "button_accept":
                  switch(this.var_18.state)
                  {
                     case TradingModel.const_211:
                        ...
                        {
                           this.alertPopup(const_1031);
                        }
                        if(this.var_18.ownUserAccepts)
                        {
                           this.var_18.method_11();
                        }
                        else
                        {
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_1619)
            {
            ...
            this.var_694.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_567);
            this.var_694.show();
         }
      ...
      private function getTraxSongFurniName(param1:GroupItem, param2:String, param3:Boolean, param4:uint = 1.0, param5:Boolean = false) : String
      {
         ...
         var _loc7_:ISongInfo = this.var_354.musicController.getSongInfo(_loc6_.extra);
         if(_loc7_ != null)
         {
         ...
         else if(param3)
         {
            ...
            this.var_354.musicController.requestSongInfoWithoutSamples(_loc6_.extra);
         }
         return param2;
      }
         ...
         if(this.var_194.length > 0)
         {
            ...
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_18.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_18.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_694.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_567);
               }
            }
            else
            {
