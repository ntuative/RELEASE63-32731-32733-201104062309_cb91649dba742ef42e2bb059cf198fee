package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_2048:int = 0;
      
      private const const_988:int = 1;
      
      private const const_1731:int = 2;
      
      private const const_1730:int = 3;
      
      private const const_1771:int = 42;
      
      private const const_1770:int = 120;
      ...
      private var var_727:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_354 = param6;
         this.var_354.events.addEventListener(SongInfoReceivedEvent.const_135,this.onSongInfoReceivedEvent);
         this.var_463 = new Map();
         this.var_463.add(FurniModel.const_46,new FurniGridView(this.var_69,FurniModel.const_46,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_463.add(FurniModel.const_51,new FurniGridView(this.var_69,FurniModel.const_51,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_354)
            {
               if(this.var_354.events != null)
               {
                  this.var_354.events.removeEventListener(SongInfoReceivedEvent.const_135,this.onSongInfoReceivedEvent);
               }
               this.var_354 = null;
            }
            this.var_194 = null;
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_463.getValue(this.var_462);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_69.getCategoryContent(this.var_462);
         if(!this.var_69.isListInited())
         {
            _loc2_ = this.const_988;
         }
      ...
      public function clearViews() : void
      {
         ...
         while(_loc4_ < _loc1_.length)
         {
            ...
            _loc3_ = this.var_463.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_463.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_463.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_69.getGroupItemInIndex(_loc3_,this.var_462);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            _loc16_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_317);
            _loc17_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_347);
            ...
            {
               if(_loc5_.category == FurniCategory.const_199)
               {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_727 && this.var_727.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
         ...
         if(_loc13_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.category == FurniCategory.const_655)
               {
                  _loc24_ = this.var_354.musicController.getSongInfo(_loc5_.extra);
                  if(_loc24_ != null)
                  {
                  ...
                  {
                     this.var_354.musicController.requestSongInfoWithoutSamples(_loc5_.extra);
         ...
         if(_loc14_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.category == FurniCategory.const_655)
               {
                  _loc25_ = this.var_354.musicController.getSongInfo(_loc5_.extra);
                  if(_loc25_ != null)
                  {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1770)
         {
            _loc3_ = this.const_1770;
         }
         else if(_loc3_ < this.const_1771)
         {
            _loc3_ = this.const_1771;
         }
         else
         {
