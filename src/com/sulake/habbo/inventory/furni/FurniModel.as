package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      private var var_1711:Vector.<Array>;
      
      private var var_1710:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_354 = param8;
         this.var_608 = new Timer(const_1281,1);
         ...
         this.var_2314 = XML(_loc10_.content);
         this.clearFurniList();
         this._view = new FurniView(this,param2,this._windowManager,this._assets,this._roomEngine,this.var_354);
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_46)
            {
               ...
               {
                  this.var_1711 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1711;
            }
            else
            {
               if(this.var_1710 == null)
               {
                  this.var_1710 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1710;
            }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(this.var_915 == null)
         {
            this.var_915 = this._windowManager.buildFromXML(this.var_2314) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_915.clone() as IWindowContainer;
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_607.add(const_46,new Array());
         this.var_607.add(const_51,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1) : void
      {
         ...
         else
         {
            ...
            for(; _loc8_ < _loc6_.length; _loc8_++)
            {
               ...
               if(_loc7_.type == param1.type)
               {
                  if(param1.category != FurniCategory.const_199)
                  {
                     _loc5_ = _loc7_;
                  }
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_322;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_315 || _loc3_.category == FurniCategory.const_295 || _loc3_.category == FurniCategory.const_348)
         {
            if(param1)
            {
               return false;
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc3_:Array = this.var_607.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            _loc4_ = 0;
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_877)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
