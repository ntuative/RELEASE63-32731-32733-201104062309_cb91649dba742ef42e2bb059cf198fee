package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1724:String = "ctlg_";
       
      
      protected var var_2101:XML;
      ...
      private var var_1181:ItemGridCatalogWidget;
      ...
      {
         var _loc2_:String = const_1724 + param1;
         ...
         this.var_2101 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2101) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1492:
               if(this.var_1181 == null)
               {
                  this.var_1181 = new ItemGridCatalogWidget(param1);
                  this.var_36.push(this.var_1181);
               }
               break;
            ...
            case CatalogWidgetEnum.const_1444:
               ...
               break;
            case CatalogWidgetEnum.const_1503:
            ...
            case CatalogWidgetEnum.const_1542:
               ...
               break;
            case CatalogWidgetEnum.const_1541:
