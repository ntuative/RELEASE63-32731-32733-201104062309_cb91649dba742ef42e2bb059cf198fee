package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.var_533 = this.getPetTypeIndexFromProduct(_loc2_.localizationId);
         if(this.var_533 < 8)
         {
            return false;
         }
         this.var_2389 = _loc2_.localizationId;
         ...
         this._offers.add(this.var_533,_loc2_);
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_203 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1350 && _loc2_ < this.var_203.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_533,this.var_203[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_533,this.var_380),this.getRaceLocalizationKey(this.var_533,this.var_380));
            }
         }
         return this.getRaceLocalizationKey(this.var_533,this.var_380);
      }
