package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1302:int = 16763904;
      
      private static const const_1301:int = 13421772;
      
      private static const const_1303:int = 13395456;
      ...
      override public function init() : Boolean
      {
         ...
         _loc4_ = this.var_259.getWithIndex(this.var_303);
         if(_loc4_ != null)
         {
            _loc3_ = _loc4_.getValue(this.var_757);
            if(_loc3_ == null)
            {
      ...
      private function onWidgetsInitialized(param1:CatalogWidgetsInitializedEvent) : void
      {
         ...
         _loc2_.push(const_1302);
         _loc2_.push(const_1301);
         _loc2_.push(const_1303);
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc2_:Map = this.var_259.getWithIndex(this.var_303);
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getValue(this.var_757);
            if(_loc3_ == null)
            {
      ...
      private function onClickNext(param1:WindowMouseEvent) : void
      {
         var _loc3_:* = null;
         ++this.var_303;
         if(this.var_303 >= this.var_259.length)
         {
            this.var_303 = 0;
         }
         var _loc2_:Map = this.var_259.getWithIndex(this.var_303);
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         if(this.var_303 < 0)
         {
            this.var_303 = this.var_259.length - 1;
         }
         var _loc2_:Map = this.var_259.getWithIndex(this.var_303);
         if(_loc2_ != null)
         {
