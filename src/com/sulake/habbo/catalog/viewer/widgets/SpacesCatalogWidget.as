package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private static const const_215:String = "floor";
      ...
      private var var_1369:String = "default";
      ...
      private var var_1368:String = "1.1";
      ...
      override public function init() : Boolean
      {
         ...
         if(_loc1_ != null)
         {
            ...
            this.changePattern(const_215,0);
            this.updateConfiguration();
            events.dispatchEvent(new CatalogWidgetUpdateRoomPreviewEvent(this._floorType,this.var_1369,this.var_1368,64));
            return true;
         }
         return false;
      }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1371[this.var_429];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_floor_pattern_prev":
               this.changePattern(const_215,-1);
               break;
            case "ctlg_floor_pattern_next":
               this.changePattern(const_215,1);
               break;
            case "ctlg_floor_color_prev":
               this.changeColor(const_215,-1);
               break;
            case "ctlg_floor_color_next":
               this.changeColor(const_215,1);
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1370[this.var_428];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               _loc3_ = this.var_1367[this.var_427];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1368);
               }
               break;
            default:
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc2_:String = this._activeWallpaperPatterns[this.var_429];
         ...
         var _loc5_:String = this.var_907[this.var_428];
         for each(_loc1_ in this.var_180.floors.pattern)
         {
            if(_loc1_.@id == _loc5_)
            {
               _loc11_ = _loc1_.children()[this.var_494];
               if(_loc11_ != null)
               {
         ...
         _loc6_ = this.var_1370[this.var_428];
         if(_loc6_ != null)
         {
         ...
         var _loc7_:String = this.var_909[this.var_427];
         for each(_loc1_ in this.var_180.landscapes.pattern)
         {
            if(_loc1_.@id == _loc7_)
            {
               _loc13_ = _loc1_.children()[this.var_495];
               if(_loc13_ != null)
               {
                  this.var_1368 = _loc13_.@id;
               }
            }
         }
         _loc8_ = this.var_1367[this.var_427];
         if(_loc8_ != null)
         {
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_216:
               ...
               if(this.var_429 < 0)
               {
                  this.var_429 = this._activeWallpaperPatterns.length - 1;
               }
               if(this.var_429 == this._activeWallpaperPatterns.length)
               {
                  this.var_429 = 0;
               }
               this.var_426 = 0;
               this.var_911 = 0;
               _loc5_ = this._activeWallpaperPatterns[this.var_429];
               for each(_loc8_ in this.var_180.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     this.var_911 = _loc8_.children().length();
                  }
               }
            ...
            case const_215:
               ...
               if(this.var_428 < 0)
               {
                  this.var_428 = this.var_907.length - 1;
               }
               if(this.var_428 >= this.var_907.length)
               {
                  this.var_428 = 0;
               }
               this.var_494 = 0;
               this.var_910 = 0;
               _loc6_ = this.var_907[this.var_428];
               for each(_loc9_ in this.var_180.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
            ...
            case TYPE_LANDSCAPE:
               ...
               if(this.var_427 < 0)
               {
                  this.var_427 = this.var_909.length - 1;
               }
               if(this.var_427 >= this.var_909.length)
               {
                  this.var_427 = 0;
               }
               this.var_495 = 0;
               this.var_908 = 0;
               _loc7_ = this.var_909[this.var_427];
               for each(_loc10_ in this.var_180.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     this.var_908 = _loc10_.children().length();
                  }
               }
