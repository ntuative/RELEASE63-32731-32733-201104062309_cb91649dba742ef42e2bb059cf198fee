package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class BotCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IAvatarImageListener
   {
      ...
      private var var_768:Offer;
      
      protected var var_471:IItemGridWindow;
      
      protected var var_1745:XML;
      
      private var var_1826:Map;
      
      private var var_344:IGridItem;
      ...
      {
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(this.var_768,page.pageId);
      }
      
      private function onBotDefinitions(param1:RentableBotDefinitionWidgetEvent) : void
      {
         this.var_1441 = param1.botFigureData;
      ...
      private function populateGridItems() : void
      {
         ...
         this.var_1745 = _loc1_.content as XML;
         var _loc2_:int = 0;
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1745) as IWindowContainer;
         this.var_471.addGridItem(_loc2_);
         param1.productContainer.view = _loc2_;
         var _loc3_:String = this.var_1441.getValue(param1.productContainer.firstProduct.extraParam.toLowerCase());
      ...
      {
         var _loc1_:String = this.var_1441.getValue(this.var_768.productContainer.firstProduct.extraParam.toLowerCase());
      ...
      private function setProductData() : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc1_.registerParameter(_loc5_,"credits",String(this.var_768.priceInCredits));
            _loc1_.registerParameter(_loc5_,"pixels",String(this.var_768.priceInActivityPoints));
            _loc2_.text = _loc1_.getKey(_loc5_);
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(this.var_768.localizationId);
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         for each(_loc3_ in page.offers)
         {
            ...
            {
               _loc4_ = this.var_1441.getValue(_loc3_.productContainer.firstProduct.extraParam.toLowerCase());
               ...
               if(_loc7_)
               {
                  ...
                  _loc6_.invalidate();
                  _loc7_.dispose();
                  if(this.var_768.offerId == _loc2_)
                  {
                     this.updatePreviewImage();
                  }
               }
