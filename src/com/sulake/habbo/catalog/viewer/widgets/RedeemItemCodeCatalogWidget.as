package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_886.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_886 = null;
         }
         if(this.var_885 != null)
         {
            this.var_885.removeEventListener(WindowKeyboardEvent.const_181,this.windowKeyEventProcessor);
            this.var_885 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_886 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_886 != null)
         {
            this.var_886.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_885 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_885 != null)
         {
            this.var_885.addEventListener(WindowKeyboardEvent.const_181,this.windowKeyEventProcessor);
         }
         return true;
      }
