package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      {
         var _loc2_:Offer = this.var_217[this.var_578][this.var_707];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_578 = var_471.getGridItemIndex(param1.view);
         var _loc2_:String = this._groupNames[this.var_578];
         var _loc3_:Array = this.var_217[this.var_578] as Array;
         var _loc4_:Array = new Array();
         for each(_loc5_ in _loc3_)
         {
            _loc6_ = _loc5_.productContainer.firstProduct.furnitureData;
            _loc7_ = _loc6_.method_2[_loc6_.method_2.length - 1];
            _loc4_.push(_loc7_);
         }
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_365 || _loc1_.pricingModel == Offer.const_372)
            {
