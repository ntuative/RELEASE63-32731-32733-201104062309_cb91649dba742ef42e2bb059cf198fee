package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.var_967 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1177 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_88 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1845 = new Point(this.var_88.x,this.var_88.y);
         this.var_516 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1448 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1844 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_967.text = _loc4_;
         this.var_1177.text = _loc5_;
         this.var_967.height = this.var_967.textHeight + 5;
         this.var_1177.y = this.var_967.y + this.var_967.height;
         this.var_1177.height = Math.max(130,this.var_1177.textHeight + 5);
         ...
         else
         {
            ...
            {
               case Offer.const_565:
                  _loc6_ = this.var_1844.clone();
                  if(this.var_516 != null)
                  {
                     this.var_516.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_516,this.var_1448,this.var_1745);
                     ...
                     case ProductTypeEnum.const_182:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_312,AvatarAction.const_552);
                              _loc16_.appendAction(AvatarAction.const_339,_loc8_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2517)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2517 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_88 != null && true)
         {
            ...
            this.var_88.x = this.var_1845.x;
            this.var_88.y = this.var_1845.y;
            if(param3 != null)
            {
