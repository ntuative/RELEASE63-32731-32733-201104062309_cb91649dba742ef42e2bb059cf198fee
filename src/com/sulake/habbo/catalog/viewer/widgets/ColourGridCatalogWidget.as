package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1962 = _loc1_.content as XML;
      ...
      private function onAvailableColours(param1:CatalogWidgetColoursEvent) : void
      {
         ...
         var _loc5_:* = null;
         this.var_1012 = [];
         for each(_loc2_ in param1.method_2)
         {
            this.var_1012.push([_loc2_]);
         }
         ...
         this.var_1011 = _loc5_.content as BitmapData;
      ...
      private function onAvailableMultiColours(param1:CatalogWidgetMultiColoursEvent) : void
      {
         ...
         for each(_loc2_ in param1.method_2)
         {
            this.var_1012.push(_loc2_.slice());
         }
         _loc3_ = page.viewer.catalog.assets.getAssetByName(param1.backgroundAssetName) as BitmapDataAsset;
         this.var_667 = _loc3_.content as BitmapData;
         _loc4_ = page.viewer.catalog.assets.getAssetByName(param1.colourAssetName) as BitmapDataAsset;
      ...
      private function select(param1:IWindowContainer) : void
      {
         ...
         {
            _loc2_ = this.var_344.getChildByName("chosen");
            if(_loc2_ != null)
            {
      ...
      private function populateColourGrid() : void
      {
         ...
         var _loc12_:int = 0;
         var _loc13_:int = 0;
         Logger.log("[ColourGridCatalogWidget] Display colors: " + [this.var_1012.length,this.var_384.numGridItems]);
         this.var_384.destroyGridItems();
         this.var_344 = null;
         for each(_loc1_ in this.var_1012)
         {
            if(_loc1_.length > 0)
            {
               _loc2_ = page.viewer.catalog.windowManager.buildFromXML(this.var_1962) as IWindowContainer;
               ...
               if(_loc3_ != null)
               {
                  _loc3_.bitmap = new BitmapData(this.var_667.width,this.var_667.height,true,0);
                  _loc3_.bitmap.copyPixels(this.var_667,this.var_667.rect,new Point(0,0));
               }
               ...
               if(_loc5_ != null)
               {
                  _loc5_.bitmap = new BitmapData(this.var_1011.width,this.var_1011.height,true,16777215);
                  _loc5_.bitmap.copyPixels(this.var_1011,this.var_1011.rect,new Point(0,0),null,null,true);
