   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_231,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_662,this.deActivateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_184,this.deActivateScrollbar);
         }
      }
      ...
      protected function loadItemGridGraphics(param1:TimerEvent = null) : void
      {
         ...
         while(_loc2_ < 3)
         {
            if(this.var_732 >= 0 && this.var_732 < page.offers.length)
            {
               _loc3_ = page.offers[this.var_732];
               this.loadGraphics(_loc3_);
               _loc3_.productContainer.grid = this;
            }
            ++this.var_732;
            if(this.var_732 >= page.offers.length)
            {
               this.resetTimer();
               break;
            }
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         if(param1.pricingModel == Offer.const_565)
         {
            ++this.var_1674;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_1674);
         }
      }
