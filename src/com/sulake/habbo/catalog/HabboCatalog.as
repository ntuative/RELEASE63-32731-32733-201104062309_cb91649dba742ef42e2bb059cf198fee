package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private static const const_620:uint = 1;
      ...
      private var var_184:CatalogViewer;
      
      private var var_366:ICatalogNavigator;
      ...
      private var var_307:ChargeConfirmationDialog;
      ...
      private var var_2468:GiftWrappingConfiguration;
      
      private var var_1167:ClubGiftController;
      
      private var var_515:ClubBuyController;
      
      private var var_766:Map;
      
      private var var_1165:Boolean = false;
      
      private var var_957:IPurchasableOffer;
      
      private var var_1440:IDragAndDropDoneReceiver;
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         {
            this.var_515.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_366.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      {
         var _loc2_:Array = this.var_766.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_104.getActivityPointsForType(Purse.const_209)));
         var _loc1_:int = 0;
      ...
      {
         this.var_170.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_133,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         {
            this.var_170.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_60,HabboToolbarIconEnum.CATALOGUE,this._mainContainer));
         }
         if(this.mainWindowVisible())
         {
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_184.getCurrentLayoutCode();
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_366 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_184 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_184.habboCatalog = this;
      }
      
      private function createMainWindow() : void
      {
         var _loc1_:XmlAsset = assets.getAssetByName("catalog") as XmlAsset;
         this._mainContainer = this._windowManager.buildFromXML(_loc1_.content as XML,const_620) as IWindowContainer;
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_86:
               this.var_1824 = param1.session.isPrivateRoom;
      ...
      private function createClubBuyController() : void
      {
         if(this.var_515 == null)
         {
            this.var_515 = new ClubBuyController(this);
         }
      }
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_184 != null)
         {
            this.var_184.catalogWindowClosed();
         }
         if(this.var_93 != null && this.getCurrentLayoutCode() == "recycler")
         {
            this.var_93.cancel();
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_366.buildCatalogIndex(_loc2_);
         if(this.var_767 && this.var_767 != "")
         {
            this.var_366.openPage(this.var_767);
            this.var_767 = "";
            this.var_956 = -1;
         }
         else if(this.var_956 > -1)
         {
            this.var_366.openPageById(this.var_956,this.var_1825);
            this.var_956 = -1;
            this.var_1825 = -1;
            this.var_767 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_184.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      private function onApproveNameResult(param1:ApproveNameMessageEvent) : void
      {
         ...
         this.var_184.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result,_loc2_.nameValidationInfo));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2469 && this.var_354 != null)
         {
            this.var_354.playSound(HabboSoundTypesEnum.const_1228);
         }
         this.var_2469 = false;
         if(this.var_307 != null)
         {
            this.var_307.refresh();
         }
         events.dispatchEvent(new PurseEvent(PurseEvent.const_71,this.var_104.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2467 && this.var_354 != null)
         {
            this.var_354.playSound(HabboSoundTypesEnum.const_1042);
         }
         this.var_2467 = false;
         if(this.var_307 != null)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1167.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         this.var_184.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2468 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_307 == null)
         {
            this.var_307 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_307.showChargeInfo(_loc2_);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_766.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_766.add(_loc2_.productCode,_loc3_.slice());
            this.var_184.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         param1.dispose();
         this.resetPlacedOfferData();
         if(param2.type == WindowEvent.const_200)
         {
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         if(this.var_1165 && param1.type == RoomEngineObjectEvent.const_169)
         {
            this.resetPlacedOfferData();
            if(this.var_957 == null || !param1.placedInRoom)
            {
               this.resetObjectMover();
               return;
            }
            this.var_87 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_957);
            _loc2_ = this.var_1440;
            this.resetObjectMover();
            if(_loc2_ != null)
            {
            ...
            _loc4_ = this.var_957.productContainer.firstProduct;
            ...
            if(_loc5_)
            {
               _loc5_.getModelController().setNumber(RoomObjectVariableEnum.const_320,0.5);
            }
         }
      }
      ...
      private function onItemAddedToInventory(param1:HabboInventoryItemAddedEvent) : void
      {
         ...
         if(this.var_87 && this.var_87.productClassId == param1.classId)
         {
            if(this.var_87.roomCategory == this._roomEngine.activeRoomCategory && this.var_87.roomId == this._roomEngine.activeRoomId)
            {
               ...
               if(param1.category == FurniCategory.const_315 || param1.category == FurniCategory.const_295 || param1.category == FurniCategory.const_348)
               {
      ...
      private function showMainWindow() : void
      {
         ...
         {
            _loc1_ = this._windowManager.getDesktop(const_620);
            if(_loc1_ != null)
            {
