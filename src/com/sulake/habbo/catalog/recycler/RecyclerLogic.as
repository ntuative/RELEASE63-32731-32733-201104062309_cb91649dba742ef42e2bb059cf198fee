package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_437:int = 1;
      
      private static const const_951:int = 2;
      ...
      {
         return this.var_595 != const_952;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1650 != RecyclerStatusMessageEvent.const_1167;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_595 == const_437;
      }
      ...
      {
         this.var_595 = const_951;
         this.var_112 = new Array(const_189);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1650)
         {
            case RecyclerStatusMessageEvent.const_1549:
               this.var_595 = const_437;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1167:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1573:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1130:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1685:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_112.length < const_189)
         {
            return false;
         }
         var _loc1_:int = 0;
