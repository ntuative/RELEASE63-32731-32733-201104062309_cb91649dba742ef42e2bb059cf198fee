package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1999:int = 10;
      ...
      private const const_1767:uint = 4.293848814E9;
      
      private const const_1766:uint = 4.294967295E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1678 = _loc1_.stuffTypes;
            this.var_733 = _loc1_.boxTypes;
            this.var_734 = _loc1_.ribbonTypes;
            this.var_1107 = this.var_1678[0];
            this.var_349 = this.var_733[0];
            this.var_350 = this.var_734[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_350 < 0)
         {
            this.var_350 = this.var_734.length - 1;
         }
         if(this.var_350 > this.var_734.length - 1)
         {
            this.var_350 = 0;
         }
         if(this.var_349 < 0)
         {
            this.var_349 = this.var_733.length - 1;
         }
         if(this.var_349 > this.var_733.length - 1)
         {
            this.var_349 = 0;
         }
         var _loc1_:int = this.var_733[this.var_349] * 1000 + this.var_734[this.var_350];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_91.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1107,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1356 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1678;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1107);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_733[this.var_349]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_734[this.var_350]);
         this._catalog.purchaseProductAsGift(this.var_1357,this.var_91,this.var_1355,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this.var_1357,this.var_91.offerId,this.var_1355);
               this.dispose();
               break;
            case "cancel_button":
         ...
         switch(param1.type)
         {
            case WindowEvent.const_110:
               ...
               for each(_loc7_ in this.var_218)
               {
                  ...
                  if(_loc5_.length >= this.const_1999)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2270 = _loc3_.text;
               break;
            case WindowMouseEvent.const_44:
               ...
               break;
            case WindowKeyboardEvent.const_388:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     this.highlightSuggestion(this.var_348 - 1);
                     break;
                  case Keyboard.DOWN:
                     this.highlightSuggestion(this.var_348 + 1);
                     break;
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_348) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_602 == null)
         {
            this.var_602 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_602.procedure = this.suggestionsEventHandler;
         }
         if(this.var_247 == null || this.var_602 == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_602.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_348) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_348);
         }
         this.var_348 = param1;
         if(this.var_348 < 0)
         {
            this.var_348 = _loc2_.numListItems - 1;
         }
         if(this.var_348 >= _loc2_.numListItems)
         {
            this.var_348 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_348) as IWindowContainer;
      ...
      {
         return param1 % 2 == 0 ? uint(this.const_1767) : uint(this.const_1766);
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1107;
               }
            }
            _loc4_++;
         }
