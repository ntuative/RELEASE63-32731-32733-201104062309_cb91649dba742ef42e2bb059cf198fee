package com.sulake.habbo.tracking
{
   ...
   public class LatencyTracker
   {
      ...
      public function init() : void
      {
         ...
         this.var_1793 = int(this.var_180.getKey("latencytest.interval"));
         this.var_1794 = int(this.var_180.getKey("latencytest.report.index"));
         this.var_2445 = int(this.var_180.getKey("latencytest.report.delta"));
      ...
      public function update(param1:uint, param2:int) : void
      {
         ...
         if(param2 - this.var_1795 > this.var_1793)
         {
            this.testLatency();
         }
      }
      ...
      private function testLatency() : void
      {
         ...
         this.var_628.add(this.var_1423,this.var_1795);
         this._connection.send(new LatencyPingRequestMessageComposer(this.var_1423));
         ++this.var_1423;
      }
      ...
      private function onPingResponse(param1:IMessageEvent) : void
      {
         ...
         var _loc10_:int = 0;
         var _loc11_:* = null;
         if(this.var_628 == null || this.var_223 == null)
         {
            return;
         }
         ...
         if(this.var_223.length == this.var_1794 && this.var_1794 > 0)
         {
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            ...
            if(Math.abs(_loc9_ - this.var_1796) > this.var_2445 || this.var_1796 == 0)
            {
               this.var_1796 = _loc9_;
