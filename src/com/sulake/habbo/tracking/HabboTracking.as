package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private var var_200:IHabboFriendList;
      
      private var var_1120:IHabboWindowManager;
      
      private var var_170:IHabboToolbar;
      
      private var var_142:IHabboHelp;
      ...
      private var var_605:LagWarningLogger = null;
      
      private var var_606:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_605 = new LagWarningLogger();
         this.var_606 = new ToolbarClickTracker(this);
         this.var_1373 = new Array(const_955);
         var _loc4_:int = 0;
         while(_loc4_ < const_955)
         {
            this.var_1373[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1639,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1529,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_821,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1100,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1120)
            {
               this.var_1120.release(new IIDHabboWindowManager());
               this.var_1120 = null;
            }
            if(this.var_320)
            {
            ...
            if(this.var_200)
            {
               ...
               {
                  Component(this.var_200).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_200).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_200).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_200).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_200).events.removeEventListener(HabboFriendListTrackingEvent.const_427,this.onFriendlistTrackingEvent);
               }
               this.var_200.release(new IIDHabboFriendList());
               this.var_200 = null;
            }
            if(this.var_142)
            {
               if(!this.var_142.disposed)
               {
                  this.var_142.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_142.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_142.release(new IIDHabboHelp());
               this.var_142 = null;
            }
            if(this.var_170)
            {
               ...
               {
                  this.var_170.events.removeEventListener(HabboToolbarEvent.const_37,this.onToolbarClick);
               }
            ...
            if(this._roomEngine)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomObjectRoomAdEvent.const_191,this.onRoomAdClick);
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_287,this.onRoomAction);
            ...
            {
               this.var_296.stop();
               this.var_296.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
               this.var_296 = null;
            }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_180)
         {
            if(this.var_250 != null)
            {
               this.var_250.configuration = this.var_180;
            }
            if(this.var_251 != null)
            {
               this.var_251.configuration = this.var_180;
            }
            ...
            if(this.var_180)
            {
               ...
               {
                  this.var_605.configure(this.var_180);
               }
               if(this.var_431 != null)
               {
                  this.var_431.configure(this.var_180);
               }
               if(this.var_606 != null)
               {
                  this.var_606.configure(this.var_180);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_885,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_640,this.onHotelViewEvent);
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_605 != null)
            {
               this.var_605.connection = param1;
            }
         }
      }
      ...
      private function onHotelViewEvent(param1:Event) : void
      {
         ...
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1455);
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_885:
               this.trackLoginStep(HabboLoginTrackingStep.const_1490,String(this._communication.port));
               break;
      ...
      {
         this.var_1120 = IHabboWindowManager(param2);
         if(this.var_1120)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_180)
            {
               if(this.var_180.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1373)
                  {
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1097);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1097,this.onCoreRunning);
         }
      }
      ...
      {
         this.var_200 = param2 as IHabboFriendList;
         Component(this.var_200).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_200).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_200).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_200).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_200).events.addEventListener(HabboFriendListTrackingEvent.const_427,this.onFriendlistTrackingEvent);
      }
      ...
      {
         this.var_142 = param2 as IHabboHelp;
         this.var_142.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_142.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2310)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1693);
            this.var_2310 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1100,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_821,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_191,this.onRoomAdClick);
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_287,this.onRoomAction);
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_320.events.addEventListener(AdEvent.const_540,this.onRoomAdLoad);
      }
      
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_170 = param2 as IHabboToolbar;
         this.var_170.events.addEventListener(HabboToolbarEvent.const_37,this.onToolbarClick);
      }
      ...
      {
         if(param1.type == RoomEngineEvent.const_287)
         {
            if(this.var_1708 < 1)
            {
               if(!this.var_296)
               {
                  this.var_296 = new Timer(60000,1);
                  this.var_296.addEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
                  this.var_296.start();
               }
            }
         }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_606)
         {
            this.var_606.track(param1.iconName);
         }
      }
      ...
      {
         this.var_605.chatLagDetected(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++this.var_1709;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1709);
         }
         if(this.var_496 > -1 && _loc2_ - this.var_496 > 15000)
         {
            ++this.var_1707;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1707);
         }
         this.var_496 = _loc2_;
         if(this.var_251 != null)
         {
            this.var_251.update(param1,this.var_496);
         }
         if(this.var_250 != null)
         {
            this.var_250.update(param1,this.var_496);
         }
         if(this.var_431 != null)
         {
            this.var_431.trackUpdate(param1,this,this.var_496);
         }
         if(this.var_605 != null)
         {
            this.var_605.update(this.var_496);
         }
      }
   }
}
