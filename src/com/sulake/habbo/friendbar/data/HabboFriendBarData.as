package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_624:String = "FriendBar";
      
      private static const const_623:String = "user_interaction";
      
      private static const TRACKING_EVENT_ACTION_VISIT:String = "visit_btn_click";
      
      private static const const_1365:String = "chat_btn_click";
      
      private static const const_1364:String = "find_friends_btn_click";
       
      
      private var var_208:IHabboCommunicationManager;
      
      private var var_1009:IHabboMessenger;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            if(this.var_208)
            {
               this.var_208.release(new IIDHabboCommunicationManager());
               this.var_208 = null;
            }
            if(this.var_1009)
            {
               this.var_1009.release(new IIDHabboMessenger());
               this.var_1009 = null;
            }
            this.var_137 = null;
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_208)
         {
            this.var_208.getHabboMainConnection(null).send(new FollowFriendMessageComposer(param1));
            this.var_208.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_624,const_623,TRACKING_EVENT_ACTION_VISIT));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_1009)
         {
            this.var_1009.startConversation(param1);
            if(this.var_208)
            {
               this.var_208.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_624,const_623,const_1365));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_208)
         {
            this.var_208.getHabboMainConnection(null).send(new FindNewFriendsMessageComposer());
            this.var_208.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_624,const_623,const_1364));
         }
      }
      
      private function onCommunicationManagerAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_208 = param2 as IHabboCommunicationManager;
         this.var_208.addHabboConnectionMessageEvent(new MessengerInitEvent(this.onMessengerInitialized));
         this.var_208.addHabboConnectionMessageEvent(new FriendListUpdateEvent(this.onFriendListUpdate));
         this.var_208.addHabboConnectionMessageEvent(new FindFriendsProcessResultEvent(this.onFindFriendProcessResult));
      }
      
      private function onMessengerComponentAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_1009 = param2 as IHabboMessenger;
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_137 = !!const_285 ? this.sortByNameAndOnlineStatus(this.var_137) : this.sortByName(this.var_137);
         }
         events.dispatchEvent(new FriendBarUpdateEvent(FriendBarUpdateEvent.const_507));
      }
