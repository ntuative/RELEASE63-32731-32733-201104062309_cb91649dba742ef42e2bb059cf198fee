package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_564:String = "LEFT";
      
      private var var_172:Number = 50;
      
      private var var_1295:Boolean = true;
      
      private var var_1294:Number = 1;
      
      private var var_1574:Number = 0;
      
      private var var_2047:Number = 15;
      
      private var var_2048:Number = 5;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IConnection, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_239 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_69,HabboWindowStyle.const_1174,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_1295 = String(_loc8_.relocate_by_drag.@state) == "true";
         if(this.var_1295)
         {
         ...
         this.var_1294 = _loc8_.toolbar.@margin_top;
         this.var_1574 = _loc8_.toolbar.@margin_bottom;
         this.var_2047 = _loc8_.toolbar.@min_group_margin;
         this.var_2048 = _loc8_.toolbar.@margin_to_extrabar;
         ...
         this.createGroupsFromXmlList(_loc9_,this.var_284,param1,param2,param3,this._window,this.var_333);
         this.createGroupsFromXmlList(_loc10_,this.var_692,param1,param2,param3,this.var_239,this.var_333);
         this.alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_172,this.var_564,param3);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,this.var_564);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_172,this.var_564);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_172,this.var_564);
         }
      }
      ...
      {
         this.alignWindows();
         var _loc2_:HabboToolbarEvent = new HabboToolbarEvent(HabboToolbarEvent.const_789);
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < this.var_692.length)
         {
            _loc2_ = this.var_692[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      private function alignWindows() : void
      {
         ...
         if(this._window == null || this.var_239 == null)
         {
            return;
         }
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_239.x = this.var_172 + this.var_2048;
               this.var_239.y = 0;
            ...
            case "TOP":
               ...
               this._window.y = 0;
               this.var_239.x = 0;
               this.var_239.y = this.var_172 + this.var_2048;
         ...
         _loc4_ -= this.var_1574;
         _loc4_ -= this.var_1294;
         var _loc5_:* = 0;
         _loc2_ = 0;
         ...
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_1294;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_284.length > 1)
            {
               if(this.orientation == "LEFT" || this.orientation == "RIGHT")
               {
                  _loc6_ = Number(Math.max(this.var_2047,(this._window.height - _loc5_ * _loc8_ - this.var_1294 - this.var_1574) / (this.var_284.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_2047,(this._window.width - _loc5_ * _loc8_ - this.var_1294 - this.var_1574) / (this.var_284.length - 1)));
               }
            }
         }
         _loc2_ = 0;
         while(_loc2_ < this.var_284.length)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.orientation = this.var_564;
         ...
         _loc2_ = 0;
         while(_loc2_ < this.var_692.length)
         {
            _loc3_ = this.var_692[_loc2_];
            if(_loc3_ != null)
            {
      ...
      private function onStageMouseMove(param1:MouseEvent) : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_1295 && this.var_1575)
         {
            _loc2_ = this.getTargetOrientationFromXY(param1.stageX,param1.stageY);
            if(_loc2_ != null && _loc2_ != this.var_564)
            {
               this.var_564 = _loc2_;
               this.alignWindows();
               if(this._events != null)
               {
                  _loc3_ = new HabboToolbarEvent(HabboToolbarEvent.const_467);
                  _loc3_.orientation = this.var_564;
