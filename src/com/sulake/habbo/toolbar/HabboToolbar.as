package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_1482:LogoutController;
      ...
      {
         this._view = new ToolbarView(this._windowManager,this._assetLibrary,this.var_323.getHabboMainConnection(null),events,this._config);
         if(this._config && this._config.getKey("client.logout.enabled","false") == "true")
         {
            this.var_1482 = new LogoutController(this._windowManager,this._assetLibrary,events);
         }
         if(this._view == null)
         {
            return;
         }
         events.addEventListener(HabboToolbarSetIconEvent.const_133,this.onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_1083,this.onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_136,this.onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_89,this.onSetToolbarIconStateEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_1210,this.onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1188,this.onHideWindowEvent);
         this._state = true;
