package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      {
         var _loc1_:* = null;
         while(this.var_308.length > 0)
         {
            this.var_770.shift();
            _loc1_ = this.var_308.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
      ...
      {
         return this.var_1445.indexOf(param1) > -1;
      }
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = this.var_2492.elements("menu");
      ...
      {
         var _loc3_:* = null;
         var _loc2_:int = this.var_770.indexOf(param1);
         if(_loc2_ > -1)
         {
            _loc3_ = this.getIconById(param1);
            if(_loc3_ != null)
      ...
      {
         return this.var_770.indexOf(param1) > -1;
      }
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_1444.length)
         {
            _loc2_ = this.var_770.indexOf(this.var_1444[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = this.var_308[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(this.var_1176 + _loc3_);
                  _loc3_ += this.var_1446;
               }
            }
            _loc4_++;
         }
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return this.var_308[this.var_770.indexOf(param1)];
      }
      ...
      public function getIconByMenuId(param1:String) : ToolbarIcon
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         while(_loc3_ < this.var_308.length)
         {
            _loc2_ = this.var_308[_loc3_];
            if(_loc2_ != null)
            {
