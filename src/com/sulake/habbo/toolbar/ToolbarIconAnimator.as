package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         this.var_2923 = param5;
         this._frame = 0;
         this.var_1040 = 0;
         this.var_1038 = new Array();
         this.var_1039 = new Array();
         this._state = param1.id;
         this.var_1706 = param1.nextState;
         this.var_1553 = param1.loop;
         if(param1.background != null)
         {
            this.var_834 = this.getBitmapDataFromAsset(param1.background,param2);
         }
      ...
      {
         if(this.var_1553 == true || this.var_1040 == 0)
         {
            if(this.var_1038.length > 0)
            {
               ++this._frame;
               if(this._frame >= this.var_1038.length)
               {
                  this._frame = 0;
                  ++this.var_1040;
               }
      ...
      {
         return this.var_1553 == false && this.var_1040 == 1 && this.var_1706 != this._state;
      }
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         {
            _loc3_ = new BitmapData(Math.max(param2.width,this.var_834.width),Math.max(param2.height,this.var_834.height),true,0);
            _loc4_ = _loc3_.height - this.var_834.rect.height;
            _loc3_.copyPixels(this.var_834,this.var_834.rect,new Point(0,_loc4_),null,null,true);
