package com.sulake.habbo.toolbar
{
   ...
   public class LogoutController
   {
      ...
      private const const_574:int = 46;
      
      private const const_493:int = 3;
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         _loc3_.x = _loc4_.width - _loc3_.width - this.const_493;
      ...
      private function showConfirmation() : void
      {
         if(!this.var_688)
         {
            this.var_688 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
         }
      }
