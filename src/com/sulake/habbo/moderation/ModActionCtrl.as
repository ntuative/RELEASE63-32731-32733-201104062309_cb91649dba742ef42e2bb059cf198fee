package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_503:ITextFieldWindow;
      
      private var _disposed:Boolean;
      
      private var var_668:Boolean = true;
      
      private var var_927:OffenceCategoryData;
      
      private var var_926:OffenceData;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         this.var_1131 = IButtonWindow(this.var_33.getXmlWindow("modact_offence"));
         this.var_1130 = IButtonWindow(this.var_33.getXmlWindow("modact_offencectg"));
      }
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Mod action on: " + this.var_1739;
         ...
         this.var_503 = ITextFieldWindow(this._frame.findChildByName("message_input"));
         this.var_503.procedure = this.onInputClick;
         this.var_1129 = IDropMenuWindow(this._frame.findChildByName("banLengthSelect"));
         this.prepareBanSelect(this.var_1129);
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = this.var_927 != null;
         if(this.var_926 != null)
         {
            this._frame.findChildByName("offence_txt").caption = this.var_926.name;
            this._frame.findChildByName("offence_category").visible = true;
         }
         else if(this.var_927 != null)
         {
            this.refreshButtons("offences_cont",2,this.var_927.offences,this.var_1131,this.onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,this.var_33.initMsg.offenceCategories,this.var_1130,this.onOffenceCtgButton);
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.connection.send(new ModAlertMessageComposer(this.var_1393,this.var_503.text,this.var_1394));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_927 = this.var_33.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         this.var_926 = this.var_927.offences[_loc3_];
         this.var_503.text = this.var_926.msg;
         this.var_668 = false;
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.connection.send(new ModKickMessageComposer(this.var_1393,this.var_503.text,this.var_1394));
         this.dispose();
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1129.selection < 0)
         {
            this.var_33.windowManager.alert("Alert","You must select ban lenght",0,this.onAlertClose);
            return;
         }
         this.var_33.connection.send(new ModBanMessageComposer(this.var_1393,this.var_503.text,this.getBanLength(),this.var_1394));
         this.dispose();
      }
      
      private function isMsgGiven() : Boolean
      {
         if(this.var_668 || this.var_503.text == "")
         {
      ...
      {
         var _loc1_:int = this.var_1129.selection;
