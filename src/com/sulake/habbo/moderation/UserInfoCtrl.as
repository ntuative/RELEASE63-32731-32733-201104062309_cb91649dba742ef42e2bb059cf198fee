package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_979:int = 3600;
      
      private static const const_978:int = 86400;
      
      private static const const_980:int = 31536000;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         if(param1 < 2 * const_979)
         {
            return Math.round(param1 / const_977) + " mins ago";
         }
         if(param1 < 2 * const_978)
         {
            return Math.round(param1 / const_979) + " hours ago";
         }
         if(param1 < 2 * const_980)
         {
            return Math.round(param1 / const_978) + " days ago";
         }
         return Math.round(param1 / const_980) + " years ago";
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1230.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_33.getXmlWindow("user_info"));
            this.var_1230.addChild(_loc1_);
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_33,WindowTracker.const_1048,this._data.userId),this._callerFrame,this.var_1231,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.windowTracker.show(new RoomVisitsCtrl(this.var_33,this._data.userId),this._callerFrame,this.var_1231,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.windowTracker.show(new SendMsgsCtrl(this.var_33,this._data.userId,this._data.userName,this.var_1394),this._callerFrame,this.var_1231,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.windowTracker.show(new ModActionCtrl(this.var_33,this._data.userId,this._data.userName,this.var_1394),this._callerFrame,this.var_1231,false,true);
      }
