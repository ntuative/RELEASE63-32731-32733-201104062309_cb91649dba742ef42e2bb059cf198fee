package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1492:ICheckBoxWindow;
      ...
      {
         return WindowTracker.const_1535;
      }
      ...
      public function populate() : void
      {
         ...
         this.var_985 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1493 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1492 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_33,WindowTracker.const_932,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = this.determineAction(param1,this.var_985.isSelected);
         this.var_33.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1500,_loc2_,this.var_503.text,"",""));
         if(this.var_1493.isSelected || this.var_1492.isSelected || this.var_985.isSelected)
         {
            this.var_33.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1493.isSelected,this.var_1492.isSelected,this.var_985.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1571);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1539);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_33.initMsg.roomMessageTemplates[this.var_1216.selection];
         if(_loc3_ != null)
         {
            this.var_668 = false;
            this.var_503.text = _loc3_;
         }
      }
   }
}
