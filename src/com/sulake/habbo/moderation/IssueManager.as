package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_1214:String = "issue_bundle_open";
      
      public static const const_886:String = "issue_bundle_my";
      
      public static const const_1123:String = "issue_bundle_picked";
      
      public static const const_1695:int = 15000;
       
      
      private var var_66:ModerationManager;
      
      private var var_618:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_618 = new IssueBrowser(this,this.var_66.windowManager,this.var_66.assets);
         this.var_1134 = [];
         this.var_1135 = [];
         this.var_937 = new Map();
         this.var_2395 = parseInt(this.var_66.configuration.getKey("chf.score.updatefactor","60"));
         this.var_1750 = new Timer(const_1695,0);
         this.var_1750.addEventListener(TimerEvent.TIMER,this.updatePriorities);
         this.var_1750.start();
      }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         {
            this.var_66.soundManager.playSound(HabboSoundTypesEnum.const_1101);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(this.var_936.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  this.var_936.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1489)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in this.var_103)
            {
               if(this.validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  this.var_936.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            this.var_936.add(param1.issueId,_loc2_);
         ...
         {
            _loc6_ = this.getBundles(const_886);
            _loc7_ = false;
            ...
            _loc9_ = this.var_1135.indexOf(param1.issueId);
            if(_loc9_ == -1 && _loc7_)
            {
      ...
      {
         var _loc2_:IssueHandler = this.var_937.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:* = this.var_937.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = this.var_936.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = this.var_103.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         this.var_937.add(param1,_loc3_);
      ...
      public function unhandleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = this.var_937.remove(param1);
         if(_loc3_ != null)
         {
            _loc3_.dispose();
         }
      ...
      public function issuePickFailed(param1:Array) : Boolean
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            {
               _loc12_ = _loc8_.id;
               _loc13_ = this.var_937.getValue(_loc12_) as IssueHandler;
               if(_loc13_ != null)
               {
                  _loc13_.dispose();
               }
