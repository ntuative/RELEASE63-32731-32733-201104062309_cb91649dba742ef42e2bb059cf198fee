package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2029:String = "my_issues";
      
      private const const_2028:String = "open_issues";
      
      private const const_2027:String = "picked_issues";
      ...
      private var var_1784:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_362.view.width = this.var_258.container.width;
         this.var_362.view.height = this.var_258.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            ...
            case this.const_2027:
               ...
               {
                  this.var_1784 = new PickedIssuesView(this.issueManager,this,this.var_258.container);
               }
