package com.sulake.habbo.notifications
{
   ...
   public class HabboAlertDialogManager
   {
      ...
      public function handleHotelClosedMessage(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         {
            this._localization.registerParameter("opening.hours.disconnected","h",this.method_1(openHour));
            this._localization.registerParameter("opening.hours.disconnected","m",this.method_1(openMinute));
         ...
         {
            this._localization.registerParameter("opening.hours.closed","h",this.method_1(openHour));
            this._localization.registerParameter("opening.hours.closed","m",this.method_1(openMinute));
      ...
      private function method_1(param1:int) : String
      {
