package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1309:String = "badges";
      
      private static const const_1306:String = "selectbadge";
      
      private static const const_1311:String = "inventory";
      
      private static const const_1304:String = "selectfurni";
      
      private static const const_1307:String = "credits";
      
      private static const const_1310:String = "friendlist";
      
      private static const const_1308:String = "pet_inventory";
      ...
      private var var_761:IHabboToolbar;
      ...
      private var var_510:HabboNotificationViewManager;
      
      private var var_225:HabboAlertDialogManager;
      
      private var var_760:ParkBusDialogManager;
      
      private var var_2457:Boolean;
      
      private var var_951:ClubGiftNotification;
      
      private var var_949:ClubEndingNotification;
      
      private var var_950:ClubPromoNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_948);
         }
         var _loc6_:Map = this.var_948["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_761)
         {
            this.var_761.release(new IIDHabboToolbar());
            this.var_761 = null;
         }
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_948["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
         ...
         return this.var_1158.length;
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = this.var_1158.splice(0,1);
      ...
      {
         this.var_761 = IHabboToolbar(param2);
         this.var_761.events.addEventListener(HabboToolbarEvent.const_74,this.onHabboToolbarEvent);
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_74)
         {
            ...
            this.var_510 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this.var_948["styles"],this.var_948["view"],this.var_761);
            ...
            registerUpdateReceiver(this.var_510,1);
            registerUpdateReceiver(this,2);
            this.var_305.events.addEventListener(BadgeImageReadyEvent.const_128,this.onBadgeImage);
            this.var_761.events.addEventListener(HabboToolbarEvent.const_467,this.onToolbarRepositionEvent);
         }
      }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         this.var_1432[_loc2_.badgeID] = new AchievementNotification(_loc2_.badgeID,_loc2_.achievementID,_loc2_.level,_loc2_.points,_loc2_.levelRewardPoints,_loc2_.levelRewardPointType,_loc2_.bonusPoints,assets,this._windowManager,this._localization,this._config,this._communication,this.var_305);
      }
      ...
      function onAchievementShareId(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:AchievementNotification = this.var_1432[_loc2_.badgeID] as AchievementNotification;
         delete this.var_1432[_loc2_.badgeID];
         if(_loc3_)
         {
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            this.addItem(_loc4_.value,NotificationType.const_1616,null);
         }
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_305.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1164,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1164,null);
            }
         }
      }
      ...
      private function onBadgeReceived(param1:BadgeReceivedMessageEvent) : void
      {
         ...
         if(this.var_305.userId == _loc3_)
         {
            ...
            this.addItem(!!_loc6_ ? _loc6_.value : "notifications.text.received.badge",NotificationType.const_879,_loc9_,_loc4_);
         }
      }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = this.var_489.createAvatarImage(param2,AvatarScaleType.const_55);
         if(_loc7_ != null)
         {
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         for each(_loc6_ in _loc4_.products)
         {
            if(_loc6_)
            {
               ...
               if(_loc8_)
               {
                  this.addItem(_loc8_.value,NotificationType.const_1628,_loc5_);
               }
            }
         }
      ...
      private function getProductImage(param1:String, param2:int, param3:String) : BitmapData
      {
         ...
         switch(param1)
         {
            ...
            case CatalogPageMessageProductData.const_65:
               ...
               break;
            case CatalogPageMessageProductData.const_182:
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1130)
         {
            return;
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1598)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               this.var_949 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,assets,this._windowManager,this._catalog,this._localization);
            }
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_950 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_510.isSpaceAvailable() && this.var_1158.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_510.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1309:
               ...
               {
                  this._inventory.toggleInventoryPage(InventoryCategory.const_291);
               }
               break;
            case const_1306:
               break;
      ...
      private function onBadgeImage(param1:BadgeImageReadyEvent) : void
      {
         ...
         {
            this.var_510.replaceIcon(param1);
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_760 == null)
         {
            this.var_760 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_760 != null)
         {
            this.var_760.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1118,_loc4_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1118,_loc5_);
         }
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_489.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_55);
            if(_loc6_ != null)
            {
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2457)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_879,null);
            this.var_2457 = true;
      ...
      {
         if(param2.type == WindowEvent.const_200 || param2.type == WindowEvent.const_910)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_951 && this.var_951.visible)
         {
            return;
         }
         this.var_951 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_879,_loc6_);
      }
   }
}
