package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      private var var_233:HabboMusicController;
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this._events.addEventListener(SongInfoReceivedEvent.const_135,this.onSongInfoReceivedEvent);
         this.var_80.addEventListener(RoomEngineSoundMachineEvent.const_823,this.onSoundMachinePlayEvent);
         this.var_80.addEventListener(RoomEngineSoundMachineEvent.const_875,this.onSoundMachineStopEvent);
      }
      ...
      {
         return HabboMusicPrioritiesEnum.const_186;
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_80)
            {
               this.var_80.removeEventListener(RoomEngineSoundMachineEvent.const_823,this.onSoundMachinePlayEvent);
               this.var_80.removeEventListener(RoomEngineSoundMachineEvent.const_875,this.onSoundMachineStopEvent);
               this.var_80 = null;
            }
            this._disposed = true;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_418 == param1)
         {
            this.playCurrentSongAndNotify(this.var_418);
            _loc2_ = this.getNextEntry();
            if(_loc2_ != null)
            {
               this.var_233.addSongInfoRequest(_loc2_.id);
            }
         }
      }
      ...
      public function stopPlaying() : void
      {
         this.var_418 = -1;
         this.var_590 = false;
         this.var_233.stop(HabboMusicPrioritiesEnum.const_186);
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         while(_loc3_ < this._playListEntries.length)
         {
            ...
            {
               _loc4_ = this.var_233.getSongInfo(param1.id) as SongDataEntry;
               if(_loc4_ != null)
               {
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_233.playSong(param1,HabboMusicPrioritiesEnum.const_186,_loc3_,0,0,0))
         {
      ...
      private function onPlayListMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc8_ < _loc5_.length)
         {
            ...
            {
               this.var_418 = _loc6_.id;
               _loc6_.startPlayHeadPos = Number(_loc4_) / 1000;
            }
            _loc4_ -= _loc6_.length;
            _loc8_++;
         }
         this._events.dispatchEvent(new PlayListStatusEvent(PlayListStatusEvent.const_449));
         if(_loc6_ != null && this.var_590)
         {
