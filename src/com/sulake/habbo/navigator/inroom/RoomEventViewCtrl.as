package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_2466:ITextWindow;
      
      private var var_1822:ITextWindow;
      
      private var var_1823:ITextWindow;
      
      private var var_1439:IButtonWindow;
      
      private var var_1437:IButtonWindow;
      
      private var var_2465:IButtonWindow;
      
      private var var_1438:IButtonWindow;
      
      private var var_954:IDropMenuWindow;
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         this.var_1821.visible = true;
         this.var_2466.text = this._navigator.getText("roomevent_type_" + param1.eventType);
         this._eventNameInput.setText(param1.eventName);
         this.var_765.setText(param1.eventDescription);
      ...
      {
         var _loc1_:int = this.var_954.selection;
         return _loc1_ + 1;
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc5_:String = this.var_765.getText();
         var _loc6_:Array = new Array();
         this.addTag(_loc6_,this.var_953.getText());
         this.addTag(_loc6_,this.var_955.getText());
      ...
      private function isMandatoryFieldsFilled() : Boolean
      {
         ...
         if(!this.var_765.checkMandatory(this._navigator.getText("navigator.eventsettings.descerr")))
         {
            return false;
         }
         return true;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(this._window == null)
         {
            ...
            this.var_1821 = IWindowContainer(this.find("event_type_disabled_cont"));
            this.var_2466 = ITextWindow(this.find("event_type_disabled_text"));
            this.var_1822 = ITextWindow(this.find("create_caption"));
            this.var_1823 = ITextWindow(this.find("edit_caption"));
            this.var_1439 = IButtonWindow(this.find("create_button"));
            this.var_1437 = IButtonWindow(this.find("edit_button"));
            this.var_2465 = IButtonWindow(this.find("cancel_button"));
            this.var_1438 = IButtonWindow(this.find("end_button"));
            this.var_954 = IDropMenuWindow(this.find("event_type"));
            this.prepareEventTypes();
            Util.setProcDirectly(this.var_1439,this.onCreateButtonClick);
            Util.setProcDirectly(this.var_1437,this.onEditButtonClick);
            Util.setProcDirectly(this.var_1438,this.onEndButtonClick);
            Util.setProcDirectly(this.var_2465,this.onCancelButtonClick);
            this._eventNameInput = new TextFieldManager(this._navigator,this.getInput("event_name"),25);
            this.var_765 = new TextFieldManager(this._navigator,this.getInput("event_desc"),100);
