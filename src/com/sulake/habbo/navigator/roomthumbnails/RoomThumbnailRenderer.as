package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      public static const const_543:int = 10;
      
      private static const const_966:int = 32;
      
      private static const const_1325:int = 8;
      
      private static const const_1326:int = -16;
      
      private static const const_1327:int = 40;
       
      
      private var _navigator:HabboNavigator;
      
      private var var_2549:Dictionary;
      ...
      private function initScreenLocsByPositions() : void
      {
         ...
         this.var_2549 = _loc1_;
      }
      
      private function getLoc(param1:int, param2:int) : Point
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_966 / 2);
         return new Point(param1 * const_966 + _loc3_,param2 * const_1325);
      }
      ...
      public function refreshThumbnail(param1:IWindowContainer, param2:RoomThumbnailData, param3:Boolean) : void
      {
         ...
         if(_loc5_ == null)
         {
            ...
            _loc5_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("bitmap","",HabboWindowType.const_304,HabboWindowStyle.const_43,0 | (!!param3 ? HabboWindowParam.const_41 : HabboWindowParam.const_43),new Rectangle(0,0,_loc7_.width,_loc7_.height)));
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         ...
         {
            this.var_1456 = this._navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(this.var_1456,this.var_1456.rect,new Point(0,0),null,null,true);
      }
      ...
      private function refreshObj(param1:BitmapData, param2:RoomThumbnailObjectData) : void
      {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1326,_loc4_.y + const_1327 - _loc5_.height),null,null,true);
      }
      
      public function getScreenLocForPos(param1:int) : Point
      {
         return Point(this.var_2549[param1]);
      }
   }
}
