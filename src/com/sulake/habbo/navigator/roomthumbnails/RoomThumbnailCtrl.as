package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_1848:IButtonWindow;
      
      private var var_1849:IButtonWindow;
      
      private var var_1847:IButtonWindow;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1848 = IButtonWindow(this.find("bg_tab"));
         this.var_1849 = IButtonWindow(this.find("top_tab"));
         this.var_1847 = IButtonWindow(this.find("obj_tab"));
         this.var_2523 = IWindowContainer(this.find("tile_grid"));
         this.var_2522 = IWindowContainer(this.find("now_editing_container"));
         Util.setProcDirectly(this.find("save"),this.onSaveButton);
         Util.setProcDirectly(this.find("cancel"),this.onCancelButton);
         Util.setProcDirectly(this.var_1848,this.onBgTabButton);
         Util.setProcDirectly(this.var_1849,this.onTopTabButton);
         Util.setProcDirectly(this.var_1847,this.onObjTabButton);
      }
      ...
      {
         this.setEnabled(this.var_1848,this.var_69.mode != ThumbnailEditorModel.const_39);
         this.setEnabled(this.var_1849,this.var_69.mode != ThumbnailEditorModel.const_63);
         this.setEnabled(this.var_1847,this.var_69.mode != ThumbnailEditorModel.const_35);
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = this.var_2522;
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = this.var_2523;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_543)
            {
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            _loc11_ = IRegionWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",WindowType.const_579,HabboWindowStyle.const_43,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
            _loc11_.mouseThreshold = 0;
            _loc12_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_304,HabboWindowStyle.const_43,HabboWindowParam.const_62,new Rectangle(0,0,66,66),this.onImgSel,_loc10_.id));
