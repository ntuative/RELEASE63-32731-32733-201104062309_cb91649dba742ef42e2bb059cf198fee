package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1289:TextFieldManager;
      ...
      private function updateArrowPos(param1:Event) : void
      {
         ...
         _loc3_.y += !!this.var_2045 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_2045 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_1289 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_193.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         this.var_1289.goBackToInitialState();
         this.var_1289.input.textBackgroundColor = 4294967295;
      ...
      {
         return Boolean(this.var_1289.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_1289.getText();
