package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_447:IRoomSettingsCtrlOwner;
      ...
      private var var_784:TextFieldManager;
      ...
      private var var_643:ICheckBoxWindow;
      ...
      private var var_2601:ITextWindow;
      ...
      public function onRoomSettings(param1:RoomSettingsData) : void
      {
         ...
         this._active = true;
         this.var_1888 = true;
         this.var_447.roomSettingsRefreshNeeded();
      }
      ...
      {
         if(param1 != this.var_374 || this.var_1206 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         {
            this.var_784.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1439)
         {
            this.var_784.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1603)
         {
            this.var_982.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_784.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_300,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_587,this.onDoorModePasswordUnselect);
         ...
         this.var_784 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         ...
         this.var_1203 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1205 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1200 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_643 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1887 = IWindowContainer(this._window.findChildByName("header_container"));
         this.var_1478 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1199 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         ...
         this.var_1476 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_267 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1201 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_2601 = ITextWindow(this._window.findChildByName("basic_caption"));
         this.var_2602 = ITextWindow(this._window.findChildByName("advanced_caption"));
         this.var_1477 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1477.mouseThreshold = 0;
         this.var_1477.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1201.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1887.visible = this._inRoom;
         this._switchViewContainer.visible = this._inRoom;
         this.var_2602.visible = this.var_525;
         this.var_2601.visible = !this.var_525;
         if(this.var_525)
         {
         ...
         {
            this.populateForm();
            this.var_1199.visible = true;
            this.var_1476.visible = true;
            this.var_1478.visible = this._inRoom;
            this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(this.var_1478.findChildByName("picframe")),this._navigator.data.enteredGuestRoom.thumbnail,false);
            this.var_1199.height = Util.getLowestPoint(this.var_1199) + 4;
         }
         this.var_1477.text = !!this.var_525 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1887.name,this.var_1478.name,this.var_1199.name,this.var_1204.name,this.var_1476.name,this._switchViewContainer.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_784.setText(_loc1_.name);
         ...
         if(this.var_643)
         {
            ...
            {
               this.var_643.unselect();
            }
            _loc6_ = 1;
            _loc7_ = 16777215;
            if(!this.hideWallsAllowed())
            {
               this.var_643.disable();
               _loc6_ = 0.5;
               _loc7_ = 8421504;
            }
            else
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_784.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_554;
         }
         ...
         _loc2_.allowPets = this.var_1203.isSelected;
         _loc2_.allowFoodConsume = this.var_1205.isSelected;
         _loc2_.allowWalkThrough = this.var_1200.isSelected;
         _loc2_.hideWalls = this.var_643.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_953,_loc2_.tags);
         this.addTag(this.var_955,_loc2_.tags);
         this.clearErrors();
         this.var_1206 = _loc2_.roomId;
