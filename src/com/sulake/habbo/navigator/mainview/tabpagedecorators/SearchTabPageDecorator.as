package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class SearchTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_1751:TextSearchInputs;
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(this.var_1751 == null)
         {
            ...
            this.var_1751 = new TextSearchInputs(this._navigator,false,_loc4_);
         ...
         {
            this.var_1751.searchStr.setText(this._navigator.data.guestRoomSearchResults.searchParam);
         }
      ...
      private function refreshSearchInfo(param1:IWindowContainer) : void
      {
         ...
         {
            _loc5_.visible = true;
            if(this._navigator.data.guestRoomSearchResults.searchType == Tabs.const_428)
            {
      ...
      {
         Util.setProc(param1,"clear_results",this.method_9);
      }
      ...
      private function method_9(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._navigator.mainViewCtrl.startSearch(Tabs.const_273,Tabs.const_225,"-1",MainViewCtrl.const_817);
      }
