package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_532:RoomPopupCtrl;
      ...
      public function GuestRoomListCtrl(param1:HabboNavigator)
      {
         ...
         this.var_532 = new RoomPopupCtrl(this._navigator,5,-5);
      ...
      {
         this.var_193 = param1;
         this.var_59 = IItemListWindow(this.var_193.findChildByName("item_list"));
         this.var_569 = IScrollbarWindow(this.var_193.findChildByName("scroller"));
      }
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_1688,true);
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         this._navigator.refreshButton(param1,"doormode_doorbell_small",param2.doorMode == RoomSettingsFlatInfo.const_190,null,0);
      ...
      private function onRow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(this.var_532.visible && this.var_2680)
            {
               return;
            }
            ...
            this.var_532.room = _loc4_;
            this.var_532.showPopup(param2);
         }
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         {
            _loc2_ = this.var_1504.tags[0];
            this.var_1504.color = this.getBgColor(_loc2_);
         }
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(this.var_2679 - _loc2_.stageX);
         this.var_2679 = _loc2_.stageX;
         this.var_2680 = _loc3_ > 2;
      }
   }
}
