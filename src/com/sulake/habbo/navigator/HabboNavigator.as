package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_461:RoomInfoViewCtrl;
      
      private var var_1257:RoomCreateViewCtrl;
      ...
      private var var_2952:Dictionary;
      ...
      private var var_313:GuestRoomDoorbell;
      
      private var var_1256:OfficialRoomEntryManager;
      
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2757 = new Array();
         ...
         this.var_461 = new RoomInfoViewCtrl(this);
         this.var_1257 = new RoomCreateViewCtrl(this);
         this.var_2610 = new RoomThumbnailRenderer(this);
         this.var_982 = new GuestRoomPasswordInput(this);
         this.var_313 = new GuestRoomDoorbell(this);
         this.var_422 = new Tabs(this);
         this.var_1256 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_304,HabboWindowStyle.const_43,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_461.registerToolbarEvents();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_170.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_133,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this.var_170.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_133,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         if(param1.type == HabboToolbarEvent.const_37)
         {
            ...
            {
               this.var_461.handleToolbarEvent(param1);
            }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_170.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_60,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      {
         var _loc1_:Boolean = this.var_324.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_324.startSearch(Tabs.const_273,Tabs.const_428,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_324.startSearch(Tabs.const_335,Tabs.const_267);
         this.var_422.getTab(Tabs.const_335).tabPageDecorator.tabSelected();
      }
