package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_631:String = "temporary_room";
      ...
      private static const const_1392:String = "tile_cursor";
      
      private static const const_993:int = -3;
      
      private static const const_1391:String = "selection_arrow";
      ...
      private var var_1042:IRoomRendererFactory = null;
      ...
      private var var_1043:RoomMessageHandler = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_1043 = new RoomMessageHandler(this);
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1042.release(new IIDRoomRendererFactory());
            this.var_1042 = null;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this._roomManager != null)
         {
            ...
            _loc2_ = this._roomManager.getRoom(this.getRoomIdentifier(this.var_99,this.var_100));
      ...
      {
         this.var_1277 = false;
         if(this.var_558 && this.var_558.length > 0)
         {
      ...
      private function addBtnMouseCursorOwner(param1:int, param2:int) : void
      {
         ...
         var _loc3_:int = this.var_558.indexOf(param2);
         if(_loc3_ == -1)
         {
            this.var_558.push(param2);
            this.var_1277 = true;
         }
      }
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         while(_loc2_ < this.var_330.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc10_ != null)
               {
                  if(_loc5_ != this.var_99 || _loc6_ != this.var_100 || !this.var_1276)
                  {
         ...
         if(_loc8_ != null && _loc9_ != null && _loc10_ != null)
         {
            ...
            if(_loc12_ != null)
            {
               ...
               if(_loc9_.screenWd != _loc13_ || _loc9_.screenHt != _loc14_ || _loc9_.scale != _loc8_.scale || _loc9_.geometryUpdateId != _loc8_.updateId || !Vector3d.isEqual(param4,_loc9_.targetObjectLoc) || _loc9_.isMoving)
               {
                  ...
                  _loc16_ = _loc10_.getNumber(RoomVariableEnum.const_854) - 0.5;
                  _loc17_ = _loc10_.getNumber(RoomVariableEnum.const_756) - 0.5;
                  _loc18_ = _loc10_.getNumber(RoomVariableEnum.const_811) + 0.5;
                  _loc19_ = _loc10_.getNumber(RoomVariableEnum.const_925) + 0.5;
                  ...
                  if(_loc33_ != null)
                  {
                     ...
                     if((_loc33_.x < _loc12_.left || _loc33_.x > _loc12_.right) && !_loc37_ || (_loc33_.y < _loc12_.top || _loc33_.y > _loc12_.bottom) && !_loc38_ || _loc37_ && !_loc9_.centeredLocX || _loc38_ && !_loc9_.centeredLocY || (_loc9_.method_3 != _loc34_.width || _loc9_.roomHt != _loc34_.height))
                     {
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1042 = param2 as IRoomRendererFactory;
         this.initializeRoomManager();
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_1043 != null)
            {
               this.var_1043.connection = param1;
            }
         }
      }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_13 != null)
         {
            events.addEventListener(RoomContentLoader.const_650,this.onContentLoaderReady);
            this.var_13.initialize(events,this.var_168);
         }
         this.var_2803 = this.var_168.getKey("room.dragging.always_center","0") == "1";
         this.initializeRoomManager();
      }
      
      private function onContentLoaderReady(param1:Event) : void
      {
         if(param1 != null && param1.type == RoomContentLoader.const_650)
         {
            this.var_2801 = true;
            this.initializeRoomManager();
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_320.events.addEventListener(AdEvent.const_540,this.showRoomAd);
         this.var_320.events.addEventListener(AdEvent.const_643,this.onRoomAdImageLoaded);
         this.var_320.events.addEventListener(AdEvent.const_713,this.onRoomAdImageLoaded);
      }
      ...
      {
         if(this.var_841 == null || this.var_482 == null || this._roomManager == null || this.var_1042 == null || this._communication == null || this.var_168 == null || !this.var_2801)
         {
            return;
         }
      ...
      public function setIsPlayingGame(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         {
            _loc5_ = !!param3 ? 1 : 0;
            _loc4_.setNumber(RoomVariableEnum.const_1094,_loc5_);
            if(_loc5_ == 0)
            {
            ...
            {
               events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_592,param1,param2));
            }
         }
      }
      ...
      public function getIsPlayingGame(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            _loc4_ = _loc3_.getNumber(RoomVariableEnum.const_1094);
            if(_loc4_ > 0)
            {
               return true;
            }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_287,param1,param2));
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(this.isPublicRoomWorldType(param6))
         {
            ...
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_1230,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_836,1,true);
            _loc12_ = parseInt(this.var_168.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_1096,_loc12_,true);
            if(this.var_13 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_355,const_632,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_836,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_830,_loc10_,true);
         if(param2 != null)
         {
            _loc13_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_854,_loc15_);
               _loc7_.setNumber(RoomVariableEnum.const_811,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_756,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_925,_loc18_);
               _loc13_ += _loc15_ * 423 + _loc16_ * 671 + _loc17_ * 913 + _loc18_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1213,_loc13_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         {
            ...
            if(param3 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_902,param3);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
               _loc7_.setString(RoomObjectVariableEnum.const_347,param3);
            }
            if(param4 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_676,param4);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
               _loc7_.setString(RoomObjectVariableEnum.const_317,param4);
            }
            if(param5 != null)
            {
               ...
               if(param2.doors.door.length() > 0)
               {
                  ...
                  while(_loc23_ < _loc20_.length())
                  {
                     ...
                     if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                     {
                        ...
                        _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_585,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_257);
                        _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                        if(_loc28_ == 90 || _loc28_ == 180)
                        {
                           if(_loc28_ == 90)
                           {
                              _loc7_.setNumber(RoomObjectVariableEnum.const_709,_loc25_ - 0.5,true);
                              _loc7_.setNumber(RoomObjectVariableEnum.const_868,_loc26_,true);
                           }
                           if(_loc28_ == 180)
                           {
                              _loc7_.setNumber(RoomObjectVariableEnum.const_709,_loc25_,true);
                              _loc7_.setNumber(RoomObjectVariableEnum.const_868,_loc26_ - 0.5,true);
                           }
                           _loc7_.setNumber(RoomObjectVariableEnum.const_1202,_loc27_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_1025,_loc28_,true);
                        }
                     }
                     _loc23_++;
                  }
         ...
         _loc7_.createRoomObject(const_994,const_1392,RoomObjectCategoryEnum.const_334);
         if(this.var_168.getKey("avatar.widget.enabled","0") == "0")
         {
            _loc7_.createRoomObject(const_993,const_1391,RoomObjectCategoryEnum.const_334);
         }
         return _loc7_;
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_355,RoomObjectCategoryEnum.const_83);
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc10_ = this.var_396.getValue(_loc9_);
            if(_loc10_ == null)
            {
               _loc10_ = new RoomData(param1,param2,null);
               this.var_396.add(_loc9_,_loc10_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            ...
            _loc8_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_902,param3);
         ...
         if(param4 != null)
         {
            ...
            _loc8_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_676,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc8_);
         }
         if(param5 != null)
         {
            ...
            _loc8_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_744,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc8_);
         }
         return true;
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1560,param3,param4,param5);
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1233,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1179,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = this.var_1042.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_830);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_709);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_868);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1202);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1025);
      ...
      private function handleRoomDragging(param1:IRoomRenderingCanvas, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         var _loc10_:* = null;
         var _loc11_:* = null;
         var _loc8_:int = param2 - this.var_1562;
         ...
         if(param4 == MouseEvent.MOUSE_DOWN)
         {
            if(!param5 && !param6 && !param7)
            {
               this.var_1276 = true;
               this.var_843 = false;
               this.var_2800 = this.var_1562;
               this.var_2802 = this.var_1563;
            }
         }
         else if(param4 == MouseEvent.MOUSE_UP)
         {
            if(this.var_1276)
            {
               ...
               if(this.var_843)
               {
                  _loc10_ = this.getRoomInstanceData(this.var_99,this.var_100);
                  if(_loc10_ != null)
                  {
         ...
         else if(param4 == MouseEvent.MOUSE_MOVE)
         {
            if(this.var_1276)
            {
               if(!this.var_843)
               {
                  _loc8_ = param2 - this.var_2800;
                  _loc9_ = param3 - this.var_2802;
            ...
            if(!this.handleRoomDragging(_loc9_,param2,param3,param4,param5,param6,param7))
            {
               if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
               {
                  ...
                  if(param4 == MouseEvent.CLICK)
                  {
                     if(events != null)
                     {
                        events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_496,this.var_99,this.var_100,-1,RoomObjectCategoryEnum.const_164));
                     }
                     _loc13_ = "null";
                  }
                  else if(param4 == MouseEvent.MOUSE_MOVE)
                  ...
                  if(this.var_78 != null)
                  {
                     _loc14_ = new RoomObjectMouseEvent(_loc13_,null,const_355,const_632);
                     this.var_78.handleRoomObjectEvent(_loc14_,this.var_99,this.var_100);
                  }
               }
            }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc6_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_99,this.var_100,this.var_1561);
         if(_loc6_ != null)
         {
            ...
            if(_loc10_ != null)
            {
               _loc10_.x = this.var_1562 - _loc5_.data.width / 2;
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_99,this.var_100,this.var_1561);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_99,this.var_100,this.var_1561);
         if(_loc1_ != null)
         {
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_78 != null)
         {
            return this.var_78.modifyRoomObject(this.var_99,this.var_100,param1,param2,param3);
         }
         return false;
      }
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_78 != null)
         {
            ...
            {
               return this.var_78.modifyWallItemData(this.var_99,this.var_100,param1,param3);
            }
         }
         return false;
      }
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(this.var_78 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_26)
            {
               return this.var_78.deleteWallItem(this.var_99,this.var_100,param1);
            }
         }
         return false;
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_836) != 0)
         {
            return false;
         }
         if(this.var_78 != null)
         {
            return this.var_78.initializeRoomObjectInsert(this.var_99,this.var_100,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(this.var_78 != null)
         {
            this.var_78.cancelRoomObjectInsert(this.var_99,this.var_100);
         }
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_993,RoomObjectCategoryEnum.const_334);
      }
      
      public function getTileCursor(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_994,RoomObjectCategoryEnum.const_334);
      }
      ...
      private function addObjectFurnitureFromData(param1:int, param2:int, param3:int, param4:FurnitureData) : Boolean
      {
         ...
         if(_loc9_ != null && _loc9_.getModelController() != null && _loc5_)
         {
            ...
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_319,param4.typeId,true);
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_374,_loc8_,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_647,1,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1144,param4.expiryTime);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1061,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_363,param1,param2,param3,RoomObjectCategoryEnum.const_28));
         }
      ...
      private function addObjectWallItemFromData(param1:int, param2:int, param3:int, param4:FurnitureData) : Boolean
      {
         ...
         if(_loc8_ != null && _loc8_.getModelController() != null)
         {
            ...
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_319,param4.typeId,true);
            _loc8_.getModelController().setString(RoomObjectVariableEnum.const_374,_loc7_,true);
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_1091,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_363,param1,param2,param3,RoomObjectCategoryEnum.const_26));
         }
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1139) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_1150);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_585,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_911,_loc5_);
                  }
               }
            }
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_894,this.var_99,this.var_100,param2,param3));
            }
         }
      }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(this.var_78 != null)
         {
            this.var_78.handleRoomObjectEvent(param1,this.var_99,this.var_100);
         }
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_34:
                     _loc10_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_207);
               }
            }
         }
      ...
      private function initializeRoomForGettingImage(param1:IRoomObjectController, param2:String) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(_loc3_.length >= 3)
            {
               ...
               param1.getModelController().setString(RoomObjectVariableEnum.const_347,_loc4_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_317,_loc5_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_305,_loc6_);
               if(_loc7_ != null)
               {
                  _loc10_ = null;
                  _loc11_ = "undefined_1";
                  _loc10_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_585,_loc11_,_loc7_,new Vector3d(2,0,1.75));
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:uint = 0, param7:String = null, param8:int = -1, param9:int = -1) : ImageResult
      {
         ...
         var _loc11_:IRoomInstance = this._roomManager.getRoom(const_631);
         if(_loc11_ == null)
         {
            _loc11_ = this._roomManager.createRoom(const_631,null);
            if(_loc11_ == null)
            {
               return _loc10_;
            }
         ...
         switch(_loc13_)
         {
            ...
            case RoomObjectCategoryEnum.const_34:
               ...
               {
                  _loc14_.getModelController().setString(RoomObjectVariableEnum.const_207,param2);
               }
               else
               {
                  _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_809,int(param2));
               }
               break;
         ...
         {
            this.var_1278.add(String(_loc12_),param5);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1045,param4,true);
         }
         else
         {
            _loc11_.disposeObject(_loc12_,_loc13_);
      ...
      {
         return this.getRoomObjectBoundingRectangle(this.var_99,this.var_100,const_355,RoomObjectCategoryEnum.const_83,param1);
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = this._roomManager.getRoom(const_631);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1045);
               ...
               _loc13_ = this.var_1278.remove(String(_loc10_)) as IGetImageListener;
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(this.var_13 != null)
         {
            ...
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_422,param1.image,true);
            ...
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1169,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1134,RoomObjectVariableEnum.const_422,param1.clickUrl);
      ...
      private function onRoomAdImageLoaded(param1:AdEvent) : void
      {
         ...
         switch(param1.type)
         {
            case AdEvent.const_643:
               _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1166,param1.imageUrl,param1.clickUrl,param1.objectId,param1.image);
               break;
            case AdEvent.const_713:
