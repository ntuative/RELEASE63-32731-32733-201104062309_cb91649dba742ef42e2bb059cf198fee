package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_650:String = "RCL_LOADER_READY";
      
      private static const const_353:String = "RCL_PUBLICROOM_";
      
      private static const const_1768:int = 0;
      ...
      private static const const_627:String = "wall_place_holder";
      
      private static const const_626:String = "pet_place_holder";
      
      private static const PLACE_HOLDER_DEFAULT:String = const_441;
      
      private static const const_628:String = "room";
      
      private static const TILE_CURSOR:String = "tile_cursor";
      
      private static const const_987:String = "selection_arrow";
      ...
      public function RoomContentLoader()
      {
         ...
         this.var_2753 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         this.var_2750 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2754 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         this.var_2751 = param2.getKey("public.room.dynamic.download.url","");
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_458.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc5_ = this.var_458.getWithIndex(_loc3_) as IGraphicAssetCollection;
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
               }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            _loc8_ = this.var_671.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_671.remove(_loc7_);
               this.var_671.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2752)
         {
            ...
            {
               this._stateEvents.dispatchEvent(new Event(const_650));
            }
         }
      }
      ...
      {
         return [const_441,const_627,const_626,const_628,TILE_CURSOR,const_987];
      }
      ...
      {
         return this.var_1023.getValue(param1) as String;
      }
      
      public function getPetColor(param1:int, param2:int) : PetColorResult
      {
         var _loc3_:Map = this.var_1024[param1];
         if(_loc3_ != null)
         {
      ...
      {
         if(this.var_209 != null && this.var_209.hasWorldType(const_353 + param1))
         {
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_245 || param1 == RoomObjectVisualizationEnum.const_72 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               while(_loc9_ < _loc7_.length)
               {
                  ...
                  _loc8_.push(this.var_2751 + _loc10_);
                  _loc9_++;
               }
               return _loc8_;
         }
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_420,_loc4_);
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1527.getValue(param1) != null)
         {
            this.var_209 = this.var_1527.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_685,this.onContentLoaded);
            _loc6_ = 0;
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2753.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            ...
            else if(this.var_459[_loc5_] != null)
            {
      ...
      private function extractPetDataFromLoadedContent(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc6_ = this.var_459[param1];
            this.var_1024.add(_loc6_,_loc3_);
         }
      }
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1527.add(param1,_loc4_);
         this.var_209 = _loc4_;
         this.method_10(param1,param2);
      }
      
      private function method_10(param1:String, param2:IAssetLibrary) : int
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(param2 == null)
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         if(_loc3_ != null)
         {
            ...
            this.var_458.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:String = this.getContentType(param1);
         return this.var_458.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      private function disposeGraphicAssetCollection(param1:String) : Boolean
      {
         var _loc3_:* = null;
         var _loc2_:String = this.getContentType(param1);
         if(this.var_458[_loc2_] != null)
         {
            _loc3_ = this.var_458.remove(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      {
         if(this.getObjectCategory(const_353 + param1) == RoomObjectCategoryEnum.const_83)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_209.getWorldHeightScale(const_353 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_209 != null)
         {
            return this.var_209.getWorldScale(const_353 + param1);
         }
         return 32;
      }
