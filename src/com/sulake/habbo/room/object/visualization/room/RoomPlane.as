package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_904:IPlaneRasterizer = null;
      
      private var var_743:PlaneMaskManager = null;
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_904.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(this.needsNewTexture(param1,param2))
         {
            ...
            if(this.var_904 != null)
            {
               _loc3_ = this.var_904.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1692,this.var_2293,this.var_2294,this.var_2297,this.var_2292,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1665 != geometry.updateId)
         {
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1364.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1364[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_154.z - originZ,this.var_113.z - originZ,this.var_84.z - originZ,this.var_114.z - originZ);
            ...
            this.var_1665 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2295);
      ...
      private function renderTexture(param1:IRoomGeometry, param2:BitmapData) : void
      {
         ...
         if(this._type == const_114 || this._type == TYPE_LANDSCAPE)
         {
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(this._bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (this._type == const_114 || this._type == TYPE_LANDSCAPE))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      public function addBitmapMask(param1:String, param2:Number, param3:Number) : Boolean
      {
         ...
         if(this.var_903)
         {
            ...
            {
               _loc4_ = this.var_248[_loc5_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_248.length == this.var_902.length)
         {
            while(_loc1_ < this.var_248.length)
            {
               _loc4_ = this.var_248[_loc1_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
                  _loc6_ = false;
                  while(_loc2_ < this.var_902.length)
                  {
                     _loc7_ = this.var_902[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
         ...
         if(this.var_353.length > this.var_1365.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_903 || this.var_248.length == 0 && this.var_353.length == 0 && !this.var_352 || this.var_743 == null)
         {
            return;
         }
         ...
         if(this.var_352)
         {
            ...
            _loc9_ = param2.getCoordinatePosition(this.var_604);
            _loc10_ = 0;
            _loc11_ = 0;
            _loc5_ = 0;
            while(_loc5_ < this.var_248.length)
            {
               _loc3_ = this.var_248[_loc5_] as RoomPlaneBitmapMask;
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_70.width - this.var_70.width * _loc3_.leftSideLoc / this.var_317.length;
                  _loc11_ = this.var_70.height - this.var_70.height * _loc3_.rightSideLoc / this.var_318.length;
                  _loc12_ = _loc3_.type;
                  this.var_743.updateMask(this.var_70,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  this.var_902.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < this.var_353.length)
            {
               ...
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_70.width - this.var_70.width * _loc4_.leftSideLoc / this.var_317.length;
                  _loc11_ = this.var_70.height - this.var_70.height * _loc4_.rightSideLoc / this.var_318.length;
                  _loc13_ = this.var_70.width * _loc4_.leftSideLength / this.var_317.length;
                  _loc14_ = this.var_70.height * _loc4_.rightSideLength / this.var_318.length;
                  this.var_70.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1365.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_352 = false;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         this.var_220.copyChannel(param1,param1.rect,const_611,BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_220.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_220,this.var_220.rect,const_611,BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
