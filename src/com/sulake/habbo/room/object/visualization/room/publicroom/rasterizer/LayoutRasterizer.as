package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_823:IGraphicAssetCollection;
      
      private var var_1986:XMLList;
      ...
      private var var_1137:Point = null;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != this.var_939)
         {
            ...
            this._adBgIndex = -1;
            this._adImgIndex = -1;
            this.var_1401 = this.var_45.getValue(this.var_939);
         }
      }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         this.var_1137.x = _loc3_.x;
         this.var_1137.y = _loc3_.y;
      }
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc3_:LayoutRasterizerData = this.var_45.getValue(this.var_939);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              this.var_1752 = RoomObjectVariableEnum.const_1234;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              this.var_1752 = RoomObjectVariableEnum.const_1169;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1136 + this._adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1136 + this._adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      {
         var _loc1_:LayoutRasterizerData = this.var_45.getValue(this.var_939);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      public function showAd(param1:IRoomObjectSpriteVisualization, param2:String = "", param3:Boolean = false) : void
      {
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(this.var_1136 + this._adBgIndex);
            _loc5_ = param1.getSprite(this.var_1136 + this._adImgIndex);
         }
         ...
         {
            this.exchangeElementGraphics("billboard_img",this.var_1752);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_560;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc9_:IGraphicAsset = this.var_823.getAsset(_loc8_.@asset);
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + this.var_1137.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + this.var_1137.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(this.var_435.indexOf(_loc10_) >= 0 && this.var_938)
            {
               param1 = this.var_435.indexOf(_loc10_);
               if(this.var_620[param1] != "")
               {
                  _loc9_ = this.var_823.getAsset(this.var_620[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
      ...
      {
         this.var_938 = true;
         var _loc3_:int = this.var_435.indexOf(param1);
         if(_loc3_ < 0)
         {
