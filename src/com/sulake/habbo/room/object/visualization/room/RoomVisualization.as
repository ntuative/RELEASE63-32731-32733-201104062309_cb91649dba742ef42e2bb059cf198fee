package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1630:int = 13421772;
      
      private static const const_998:int = 16777215;
      
      private static const const_999:int = 13421772;
      
      private static const const_996:int = 10066329;
      
      private static const const_997:int = 10066329;
      
      public static const const_1527:int = 16777215;
      ...
      private var var_844:Rectangle = null;
      ...
      private var var_2815:String = null;
      
      private var var_1281:uint = 16777215;
      
      private var var_2814:int = 255;
      
      private var var_2816:int = 255;
      
      private var var_2813:int = 255;
      
      private var var_2028:Boolean = true;
      
      private var var_1804:int = 0;
      
      private var var_1985:int = -1000;
      
      private const const_2046:int = 250;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_135 != null)
         {
            ...
            {
               _loc4_ = this.var_135[_loc3_] as RoomPlane;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_844 = super.boundingRectangle;
         }
         return new Rectangle(this.var_844.x,this.var_844.y,this.var_844.width,this.var_844.height);
      }
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1163);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1213);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_215,true,_loc11_,_loc6_);
               if(_loc14_.z != 0)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1610)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_114,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this.var_1985 + this.const_2046 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_397.length)
            {
               _loc11_ = this.var_687[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_397[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_2028)
                  {
                     _loc14_ = uint(_loc13_.color);
                     _loc15_ = uint((_loc14_ & 255) * this.var_2813 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2816 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2814 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1665)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1510 || _loc3_.y != this.var_2695 || _loc3_.z != this.var_2698 || param1.scale != this.var_2696))
            {
               this.var_1510 = _loc3_.x;
               this.var_2695 = _loc3_.y;
               this.var_2698 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1024);
            if(_loc3_ != this.var_2815)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2815 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_780));
            if(_loc4_ != this.var_1281)
            {
               this.var_1281 = _loc4_;
               this.var_2813 = this.var_1281 & 255;
               this.var_2816 = this.var_1281 >> 8 & 255;
               this.var_2814 = this.var_1281 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1208));
            if(_loc5_ != this.var_2028)
            {
               this.var_2028 = _loc5_;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_175 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_317);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_347);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_305);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_858));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_929));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_784));
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < this.var_135.length)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.type == RoomPlane.const_215 && param1 != null)
               {
                  _loc5_.id = param1;
               }
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_397;
         if(this.var_397.length == 0)
         {
            _loc6_ = this.var_135;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_397.length > 0;
         var _loc9_:int = 0;
               ...
               if(_loc12_ != null)
               {
                  if(_loc12_.update(param1,_loc5_))
                  {
                     if(_loc12_.visible)
                     {
                        ...
                        if(_loc12_.type != RoomPlane.const_215)
                        {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_397.push(_loc12_);
                        this.var_687.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1804;
      }
         ...
         while(_loc8_ < this.var_561.maskCount)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               while(_loc13_ < this.var_135.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_114 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_114 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_257)
                              {
