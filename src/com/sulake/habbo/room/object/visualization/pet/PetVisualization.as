package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization implements IPetImageListener
   {
      ...
      private const const_1315:int = 3;
      ...
      private var var_1818:Number = NaN;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         this.var_398 = new ExperienceData(_loc2_.clone());
         return true;
      }
      ...
      private function updateModel(param1:IRoomObjectModel, param2:Number) : Boolean
      {
         ...
         {
            this.var_1814 = param1.getNumber(RoomObjectVariableEnum.const_399) > 0;
            this.var_1433 = param1.getString(RoomObjectVariableEnum.const_154);
            this.var_260 = param1.getString(RoomObjectVariableEnum.const_280);
            this._postureParameter = param1.getString(RoomObjectVariableEnum.const_873);
            this.var_1818 = param1.getNumber(RoomObjectVariableEnum.const_214);
            this.var_1485 = param1.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2237 = param1.getNumber(RoomObjectVariableEnum.const_804);
            this.validateActions();
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_207);
            if(this.var_640 != _loc3_)
            {
               this.var_640 = _loc3_;
      ...
      private function updateObject(param1:IRoomObject, param2:IRoomGeometry, param3:Boolean = false) : Boolean
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param3 || var_480 != param1.getUpdateID() || this.var_1665 != param2.updateId)
         {
            _loc4_ = param1.getDirection().x - param2.direction.x;
            _loc4_ = (_loc4_ % 360 + 360) % 360;
            _loc5_ = this.var_1818;
            if(isNaN(this.var_1818))
            {
               _loc5_ = _loc4_;
            }
            else
            ...
            if(_loc4_ != this.var_1817 || param3)
            {
               this.var_1817 = _loc4_;
               _loc4_ -= 112.5;
               _loc4_ = (_loc4_ + 360) % 360;
               this.var_61.setDirectionAngle(AvatarSetType.const_36,_loc4_);
            }
            if(_loc5_ != this.var_1819 || param3)
            {
      ...
      private function getAvatarImage(param1:Number) : IAvatarImage
      {
         ...
         if(_loc3_ == null)
         {
            _loc3_ = this.var_630.getAvatar(this.var_640,param1,this);
            if(_loc3_ != null)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         var _loc12_:Boolean = this.var_1028 || this.var_1215 > 0 || this.var_1909;
         this.var_398.alpha = 0;
         if(this.var_1485 > 0)
         {
            _loc13_ = param2 - this.var_1485;
            if(_loc13_ < AvatarAction.const_1001)
            {
               this.var_398.alpha = int(Math.sin(_loc13_ / 0 * 0) * 255);
               this.var_398.setExperience(this.var_2237);
               this.var_1215 = this.const_2038;
            }
            else
            {
               this.var_1485 = 0;
            }
            _loc14_ = getSprite(this.const_1753);
            if(_loc14_ != null)
            {
               if(this.var_398.alpha > 0)
               {
                  _loc14_.asset = this.var_398.image;
                  _loc14_.offsetX = -20;
                  _loc14_.offsetY = -80;
                  _loc14_.alpha = this.var_398.alpha;
         ...
         if(_loc11_ || _loc12_)
         {
            ...
            _loc14_ = getSprite(this.const_960);
            if(_loc14_)
            {
      ...
      private function updateActions(param1:IAvatarImage) : void
      {
         ...
         if(this.var_1433 != null && this.var_1433 != "")
         {
            param1.appendAction(AvatarAction.const_312,this.var_1433);
         }
         ...
         var _loc2_:int = param1.getSprites().length + this.const_1315;
