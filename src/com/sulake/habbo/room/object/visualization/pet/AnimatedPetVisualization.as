package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_633:int = 1;
      
      private static const const_1001:int = 1000;
      
      private static const const_1395:String = "pet_experience_bubble_png";
      ...
      private var var_398:ExperienceData;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1395) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_398 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_2821)
            {
               this.var_2821 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc3_.getUpdateID() != var_175)
         {
            ...
            this.var_1814 = _loc3_.getNumber(RoomObjectVariableEnum.const_399) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_214);
            if(!isNaN(_loc8_))
            {
               this.var_2032 = _loc8_;
            }
            else
            {
               this.var_2032 = direction;
            }
            this.var_1485 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2237 = _loc3_.getNumber(RoomObjectVariableEnum.const_804);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_809);
            if(_loc9_ != this.var_2031)
            {
               this.var_2031 = _loc9_;
               this.var_2820 = this.var_2031.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_398 != null)
         {
            ...
            if(this.var_1485 > 0)
            {
               _loc2_ = param1 - this.var_1485;
               if(_loc2_ < const_1001)
               {
                  this.var_398.alpha = int(Math.sin(_loc2_ / const_1001 * 0) * 255);
                  this.var_398.setExperience(this.var_2237);
               }
               else
               {
                  this.var_1485 = 0;
               ...
               if(_loc3_ != null)
               {
                  if(this.var_398.alpha > 0)
                  {
                     _loc3_.asset = this.var_398.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_398.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      {
         return super.getAdditionalSpriteCount() + const_633;
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2820);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_633)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_633))
            {
               if(param2 >= FurnitureVisualizationData.const_595.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_595[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_2032);
         }
         return direction;
      }
      ...
      {
         if(this.var_1046[param1] == null)
         {
            if(this._animationData.getTag(var_90,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1398)
            {
               this.var_1046[param1] = true;
            }
            else
            {
               this.var_1046[param1] = false;
            }
         }
