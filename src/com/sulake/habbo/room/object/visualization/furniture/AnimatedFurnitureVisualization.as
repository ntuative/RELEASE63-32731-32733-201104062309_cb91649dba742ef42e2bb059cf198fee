package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
         ...
         if(super.updateModel(param1))
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc4_ = _loc3_.getNumber(RoomObjectVariableEnum.const_888);
      ...
      protected function resetAllAnimationFrames() : void
      {
         if(this.var_117 != null)
         {
            this.var_117.setLayerCount(this.var_591);
         }
      }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         {
            this.var_922 = param1;
            this.var_591 = this._animationData.getLayerCount(param1);
      ...
      {
         var _loc2_:int = 0;
         if(!this.var_117.animationOver || this.var_923)
         {
      ...
      protected function updateFramesForAnimation(param1:AnimationStateData, param2:Number) : int
      {
         ...
         var _loc7_:* = 1 << this.var_591 - 1;
         var _loc8_:int = this.var_591 - 1;
         while(_loc8_ >= 0)
         {
            ...
            if(!_loc9_ || this.var_923)
            {
               ...
               if(this.var_923 || _loc11_ == null || _loc11_.remainingFrameRepeats >= 0 && _loc13_ <= 0)
               {
                  ...
                  if(_loc12_ == AnimationFrame.const_1041)
                  {
               ...
               if(_loc11_ == null || _loc11_.remainingFrameRepeats == AnimationFrame.const_524)
               {
                  _loc10_ = true;
                  _loc9_ = true;
               }
