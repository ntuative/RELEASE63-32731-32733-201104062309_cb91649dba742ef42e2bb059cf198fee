package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1714:String = "cone";
      
      public static const const_1553:String = "plane";
      
      public static const const_1715:String = "sphere";
      ...
      private var var_1001:Number = 0.1;
      
      private var var_1947:Number;
      
      private var var_272:Number;
      ...
      public function reset() : void
      {
         ...
         this.var_1002 = 0;
         this.var_918 = false;
         this.init(0,0,0,this._direction,this.var_2704,this.var_1001,this.var_2705,true);
      }
      ...
      {
         this.var_918 = true;
         if(this.var_1002 < this.var_1511)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2701)
         {
            switch(this.var_2702)
            {
               case const_1714:
            ...
            _loc4_.init(param1.x,param1.y,param1.z,_loc3_,this._energy,this.var_1001,_loc6_,_loc7_,_loc9_,_loc8_);
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_1002 < this.var_1511)
         {
            if(this.age % this.var_2703 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_1002 < this.var_1511)
         {
            ...
            _loc4_ = this.y;
            _loc5_ = this.z;
            this.x = (2 - this.var_272) * this.x - (1 - this.var_272) * this.lastX;
            this.y = (2 - this.var_272) * this.y - (1 - this.var_272) * this.lastY + this.var_1947 * this.var_1001 * this.var_1001;
            this.z = (2 - this.var_272) * this.z - (1 - this.var_272) * this.lastZ;
            this.lastX = _loc3_;
            this.lastY = _loc4_;
            this.lastZ = _loc5_;
         }
         ...
         for each(_loc2_ in this.var_381)
         {
            ...
            _loc4_ = _loc2_.y;
            _loc5_ = _loc2_.z;
            _loc2_.x = (2 - this.var_272) * _loc2_.x - (1 - this.var_272) * _loc2_.lastX;
            _loc2_.y = (2 - this.var_272) * _loc2_.y - (1 - this.var_272) * _loc2_.lastY + this.var_1947 * this.var_1001 * this.var_1001;
            _loc2_.z = (2 - this.var_272) * _loc2_.z - (1 - this.var_272) * _loc2_.lastZ;
            _loc2_.lastX = _loc3_;
            _loc2_.lastY = _loc4_;
            _loc2_.lastZ = _loc5_;
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            this.var_381.splice(this.var_381.indexOf(_loc2_),1);
            _loc2_.dispose();
         }
      }
