package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystem
   {
      ...
      private var var_1123:Number = 1.0;
      
      private var var_610:BitmapData;
      
      private var var_738:ColorTransform;
      
      private var var_1380:ColorTransform;
      
      private var var_1715:Matrix;
      ...
      public function FurnitureParticleSystem(param1:AnimatedFurnitureVisualization)
      {
         ...
         this.var_738 = new ColorTransform();
         this.var_738.alphaMultiplier = 1;
         this.var_1380 = new ColorTransform();
         this.var_1715 = new Matrix();
      ...
      public function setAnimation(param1:int) : void
      {
         ...
         this.var_96 = this.var_1124[param1];
         this.var_918 = false;
         this.updateCanvas();
      }
      ...
      private function updateCanvas() : void
      {
         ...
         if(this.var_1714 >= 0)
         {
            this.var_252 = this._visualization.getSprite(this.var_1714);
            if(this.var_252 && this.var_252.asset)
            {
               ...
               if(this.var_85 == null)
               {
                  ...
                  if(this.var_738.alphaMultiplier != 1)
                  {
                     this.var_610 = new BitmapData(this.var_85.width,this.var_85.height,true,4278190080);
                  }
               }
               this.var_2322 = -this.var_252.offsetX;
               this.var_2321 = -this.var_252.offsetY;
      ...
      public function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         {
            return this.var_96.y * this.var_1123;
         }
         return 0;
      }
      ...
      public function updateAnimation() : void
      {
         ...
         _loc8_ = this.var_1153 * this.var_1123;
         this.var_96.update();
         if(this.var_918)
         {
            if(this.var_96.roomObjectSpriteId >= 0)
            ...
            {
               this.var_85.draw(this.var_610,this.var_1715,this.var_738,BlendMode.NORMAL,null,false);
            }
            for each(_loc11_ in this.var_96.particles)
            {
               _loc2_ = Number(_loc11_.y);
               _loc3_ = this.var_2322 + (_loc11_.x - _loc11_.z) * 10 / 10 * this.var_1123;
               _loc4_ = this.var_2321 - _loc8_ + (_loc2_ + (_loc11_.x + _loc11_.z) / 2) * 10 / 10 * this.var_1123;
               ...
               if(_loc6_)
               {
                  ...
                  if(_loc11_.fade && _loc11_.alphaMultiplier < 1)
                  {
                     ...
                     this.var_1380.alphaMultiplier = _loc11_.alphaMultiplier;
                     this.var_85.draw(_loc7_,this._translationMatrix,this.var_1380,BlendMode.NORMAL,null,false);
                  }
                  else
                  {
      ...
      public function parseData(param1:XML) : void
      {
         ...
         var _loc23_:* = null;
         var _loc24_:* = null;
         this.var_2320 = parseInt(param1.@size);
         this.var_1714 = !!param1.hasOwnProperty("@canvas_id") ? int(parseInt(param1.@canvas_id)) : -1;
         this.var_1153 = !!param1.hasOwnProperty("@offset_y") ? int(parseInt(param1.@offset_y)) : 10;
         this.var_1123 = this.var_2320 / 64;
         this.var_714 = !!param1.hasOwnProperty("@blend") ? Number(Number(param1.@blend)) : Number(1);
         this.var_714 = Math.min(this.var_714,1);
         this.var_738.alphaMultiplier = this.var_714;
