package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1354:String = "shore";
      ...
      {
         if(this.var_2694 == param1 && this.var_2693 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,direction,_loc2_) == const_1354)
            {
               this.var_1939 = _loc2_;
               this.var_2694 = param1;
               this.var_2693 = direction;
               return this.var_1939;
            }
            _loc2_--;
         }
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_1228.indexOf(_loc2_) < 0)
            {
      ...
      private function updateBorderData() : void
      {
         ...
         this.var_1940 = false;
         _loc5_ = 0;
         while(_loc5_ < this.var_450.length)
         {
            if(this.var_450[_loc5_] == true)
            {
               this.var_1940 = true;
            }
            _loc5_++;
      ...
      private function resetBorders() : void
      {
         ...
         if(this.var_534 == 0 || this.var_661 == 0)
         {
            ...
            this.var_534 = _loc2_.getNumber(RoomObjectVariableEnum.const_301);
            this.var_661 = _loc2_.getNumber(RoomObjectVariableEnum.const_401);
         }
         this.var_450 = [];
         this.var_662 = [];
         var _loc1_:int = 0;
         ...
         {
            this.var_450.push(false);
            this.var_662.push(ShoreMaskCreatorUtility.const_77);
            _loc1_++;
         }
      }
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_70,getSize(param3),this.var_450,this.var_662,assetCollection);
      }
