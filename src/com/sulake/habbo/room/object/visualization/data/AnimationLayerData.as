   ...
   public class AnimationLayerData
   {
      ...
      public function calculateLength() : void
      {
         ...
         while(_loc1_ < this.var_234.length)
         {
            ...
            if(_loc2_ != null)
            {
               this.var_453 += _loc2_.frameCount;
            }
            _loc1_++;
         }
      }
      ...
      public function getFrame(param1:int, param2:int) : AnimationFrame
      {
         ...
         if(!this.var_1884)
         {
            _loc6_ = param2 / this.var_453;
            param2 %= this.var_453;
            if(this._loopCount > 0 && _loc6_ >= this._loopCount || this._loopCount <= 0 && this.var_453 == 1)
            {
               param2 = this.var_453 - 1;
               _loc4_ = true;
            }
            _loc7_ = 0;
            _loc5_ = 0;
      ...
      private function getFrameFromSpecificSequence(param1:int, param2:AnimationFrameSequenceData, param3:int, param4:int, param5:Boolean) : AnimationFrame
      {
         ...
         if(param2 != null)
         {
            ...
            _loc12_ = this.var_1966 * _loc11_;
            if(param5)
            {
               _loc12_ = 0;
            }
            _loc13_ = false;
            if(!this.var_1884 && !param2.isRandom)
            {
