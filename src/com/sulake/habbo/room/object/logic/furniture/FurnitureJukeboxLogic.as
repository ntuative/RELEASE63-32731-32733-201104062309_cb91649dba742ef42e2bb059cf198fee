package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureJukeboxLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_532,RoomObjectFurnitureActionEvent.const_445,RoomObjectFurnitureActionEvent.const_459,RoomObjectFurnitureActionEvent.const_527,RoomObjectWidgetRequestEvent.const_141];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         {
            object.getModelController().setString(RoomWidgetInfostandExtraParamEnum.const_476,RoomWidgetInfostandExtraParamEnum.const_752);
