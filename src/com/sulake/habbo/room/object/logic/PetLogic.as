   ...
   public class PetLogic extends MovingObjectLogic
   {
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(!this.var_2778)
         {
            ...
            if(param1 is RoomObjectAvatarChatUpdateMessage)
            {
               ...
               this.var_1543 = getTimer() + _loc5_.numberOfWords * 1000;
               return;
            }
            ...
            if(param1 is RoomObjectAvatarSleepUpdateMessage)
            {
               ...
               _loc2_.setNumber(RoomObjectVariableEnum.const_399,Number(_loc7_.isSleeping));
               return;
            }
         }
         ...
         if(param1 is RoomObjectAvatarExperienceUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_804,Number(_loc9_.gainedExperience));
            return;
         }
         if(param1 is RoomObjectAvatarFigureUpdateMessage)
         {
            _loc10_ = param1 as RoomObjectAvatarFigureUpdateMessage;
            _loc11_ = _loc2_.getString(RoomObjectVariableEnum.const_207);
            _loc2_.setString(RoomObjectVariableEnum.const_207,_loc10_.figure);
            _loc2_.setString(RoomObjectVariableEnum.const_1629,_loc10_.race);
            _loc2_.setNumber(RoomObjectVariableEnum.const_809,this.getPaletteIndex(_loc10_.figure));
            return;
         }
      }
      ...
      private function debugMouseEvent(param1:RoomSpriteMouseEvent) : void
      {
         ...
         if(!param1.altKey && !param1.ctrlKey)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_214,_loc3_ + this.var_1031);
         }
         else if(param1.altKey && !param1.ctrlKey)
         {
            ++this.var_1997;
            _loc2_.setNumber(RoomObjectVariableEnum.const_280,this.var_1997);
            _loc2_.setNumber(RoomObjectVariableEnum.const_154,NaN);
         }
         else if(param1.ctrlKey && !param1.altKey)
         {
            ++this.var_1998;
            _loc2_.setNumber(RoomObjectVariableEnum.const_154,this.var_1998);
         }
         else
         {
            this.var_1031 += 45;
