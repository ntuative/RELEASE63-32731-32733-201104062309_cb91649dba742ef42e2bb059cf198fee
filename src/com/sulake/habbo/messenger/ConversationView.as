package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1000:int = 100;
      
      private static const const_1393:int = 20;
       
      
      private var var_129:HabboMessenger;
      
      private var var_2818:IScrollbarWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         ...
         this.var_2818 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_1000 + const_1393)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1394;
         param1.invalidate();
      }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_562 == null || _loc1_.id != this.var_562.id)
         {
            this.var_562 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_562.followingAllowed)
         {
      ...
      private function refreshList() : void
      {
         ...
         this.var_59.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_562.messages.length - const_1000);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_562.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_562.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_851 || param3.type == Message.const_719 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_562.id;
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_129.send(new FollowFriendMessageComposer(this.var_562.id));
      }
