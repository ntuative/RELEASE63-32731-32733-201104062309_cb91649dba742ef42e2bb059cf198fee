package com.sulake.habbo.localization
{
   ...
   public class HabboLocalizationManager extends CoreLocalizationManager implements IHabboLocalizationManager
   {
      ...
      private static var var_1330:String = "%";
      ...
      {
         this.var_1720 = new Dictionary();
         this.var_2330 = ["I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII","XIII","XIV","XV","XVI","XVII","XVIII","XIX","XX"];
         super(param1,param2,param3);
         this.var_1721 = (param2 & 0) > 0;
         if(!this.var_1721)
         {
            lock();
         }
      ...
      private function fillParams(param1:String, param2:Dictionary) : String
      {
         ...
         while(_loc3_ < 10)
         {
            _loc4_ = param1.indexOf(var_1330);
            if(_loc4_ < 0)
            {
               break;
            }
            _loc5_ = param1.indexOf(var_1330,_loc4_ + 1);
            if(_loc5_ < 0)
            {
               break;
            }
         ...
         if(param2 != null)
         {
            ...
            if(!this.var_1721)
            {
               if("false" == this.var_180.getKey("use.default.localizations","false"))
               {
                  ...
                  events.addEventListener(LocalizationEvent.const_166,this.onLocalizationLoaded);
      ...
      {
         var _loc2_:* = null;
         events.removeEventListener(LocalizationEvent.const_166,this.onLocalizationLoaded);
         if(this.var_180.keyExists("external.override.texts.txt"))
         {
            _loc2_ = this.var_180.getKey("external.override.texts.txt");
            events.addEventListener(LocalizationEvent.const_166,this.onLocalizationOverrideLoaded);
      ...
      {
         events.removeEventListener(LocalizationEvent.const_166,this.onLocalizationOverrideLoaded);
         unlock();
      }
      ...
      {
         this.var_1720[param1] = param2;
      }
      
      private function getBadgePointLimit(param1:String) : int
      {
         return this.var_1720[param1];
      }
      ...
      {
         return this.var_2330[Math.max(0,param1 - 1)];
      }
   }
}
