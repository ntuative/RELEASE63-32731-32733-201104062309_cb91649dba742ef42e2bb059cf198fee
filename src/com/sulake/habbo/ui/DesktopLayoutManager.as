package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private const const_1295:String = "room_view";
      
      private const const_2013:String = "room_widget";
      
      private var var_48:IWindowContainer;
      
      private var var_754:int = 50;
      
      private var var_2905:XML = null;
      ...
      public function addWidgetWindow(param1:IWindow) : Boolean
      {
         ...
         {
            if(String(_loc2_[_loc4_]).indexOf(this.const_2013) == 0)
            {
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = this.var_48.getChildByTag(this.const_1295) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function set toolbarOrientation(param1:String) : void
      {
         ...
         {
            case "LEFT":
               _loc2_.x = this.var_754;
               _loc2_.width = this.var_48.desktop.width - this.var_754;
               _loc2_.y = 0;
            ...
            case "TOP":
               ...
               _loc2_.y = this.var_754;
               _loc2_.height = this.var_48.desktop.height - this.var_754;
               break;
            case "BOTTOM":
               _loc2_.x = 0;
               _loc2_.width = this.var_48.desktop.width;
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = this.var_48.findChildByTag(this.const_1295) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
