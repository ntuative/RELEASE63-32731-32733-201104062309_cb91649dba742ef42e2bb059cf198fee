package com.sulake.habbo.ui
{
   ...
   public class PurseWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetPurseData.const_755);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetPurseData.const_755:
               ...
               this._container.events.dispatchEvent(new RoomWidgetPurseUpdateEvent(RoomWidgetPurseUpdateEvent.const_108,_loc2_.getActivityPointsForType(Purse.const_209)));
               break;
            case RoomWidgetOpenCatalogMessage.const_400:
               ...
               if(this._container.catalog != null)
               {
                  ...
                  {
                     case RoomWidgetOpenCatalogMessage.const_1035:
                        this._container.catalog.openCatalogPage(CatalogPageName.const_1633);
                        break;
                     case RoomWidgetOpenCatalogMessage.const_1072:
