package com.sulake.habbo.ui
{
   ...
   public class FurnitureCreditWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_918,RoomWidgetCreditFurniRedeemMessage.const_700];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_918:
               ...
               if(_loc4_ != null)
               {
                  ...
                  if(_loc6_ != null)
                  {
                     ...
                     _loc8_ = new RoomWidgetCreditFurniUpdateEvent(RoomWidgetCreditFurniUpdateEvent.const_710,_loc3_.id,_loc7_);
