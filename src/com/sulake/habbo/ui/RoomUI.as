package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_1240:IRoomWidgetFactory;
      
      private var var_305:ISessionDataManager;
      
      private var _friendList:IHabboFriendList;
      
      private var var_489:IAvatarRenderManager;
      ...
      {
         this.var_1517 = RoomDesktop.const_452;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1240.release(new IIDHabboRoomWidget());
            this.var_1240 = null;
         }
         ...
         {
            this.var_489.release(new IIDAvatarRenderManager());
            this.var_489 = null;
         }
         ...
         {
            this.var_1007.release(new IIDHabboModeration());
            this.var_1007 = null;
         }
         ...
         if(this.var_1239)
         {
            this.var_1239.release(new IIDHabboUserDefinedRoomEvents());
            this.var_1239 = null;
         }
         this.var_1954 = null;
      ...
      private function onRoomWidgetFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1240 = param2 as IRoomWidgetFactory;
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_489 = param2 as IAvatarRenderManager;
      }
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1954 = param2 as IHabboAvatarEditor;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            this.var_320.events.addEventListener(AdEvent.const_494,this.adEventHandler);
            this.var_320.events.addEventListener(AdEvent.const_594,this.adEventHandler);
            this.var_320.events.addEventListener(AdEvent.const_540,this.adEventHandler);
         }
      }
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1007 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + this.var_1007);
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_15)
         {
            this.var_15.events.addEventListener(RoomSessionEvent.const_243,this.roomSessionStateEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionUserBadgesEvent.const_75,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionUserGivableBadgesEvent.const_75,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionPresentEvent.const_330,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionPetPackageEvent.const_450,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionPetPackageEvent.const_589,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionViralFurniStatusEvent.const_447,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionViralFurniStatusEvent.const_504,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_865,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1108,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1226,this.roomSessionDialogEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_860,this.roomSessionDialogEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_795,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionQueueEvent.const_581,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionDimmerPresetsEvent.const_462,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionUserDataUpdateEvent.const_121,this.roomSessionEventHandler);
         }
      }
      ...
      private function roomSessionStateEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionEvent.const_243:
            ...
            case RoomSessionEvent.const_88:
               if(param1.session != null)
               {
                  ...
                  this.var_170.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_136,HabboToolbarIconEnum.ZOOM));
                  this.var_170.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_136,HabboToolbarIconEnum.MEMENU));
                  this.var_170.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_136,HabboToolbarIconEnum.INVENTORY));
               }
         }
      }
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_241:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_865:
            ...
            case RoomSessionErrorMessageEvent.const_856:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_860:
               errorMessage = "${room.error.pets.forbidden_in_flat}";
               break;
            case RoomSessionErrorMessageEvent.const_862:
               errorMessage = "${room.error.pets.no_free_tiles}";
               break;
            case RoomSessionErrorMessageEvent.const_795:
      ...
      {
         this.var_1239 = param2 as IHabboUserDefinedRoomEvents;
      }
      ...
      private function initializeRoomEngineEvents() : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_712,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_287,this.roomEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_592,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineDimmerStateEvent.const_64,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_882,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_846,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_894,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_169,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_824,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineSoundMachineEvent.const_387,this.roomObjectEventHandler);
         }
      }
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         else if(param1.type == RoomEngineEvent.const_592 || param1.type == RoomEngineEvent.const_519)
         {
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_287:
               _loc5_ = false;
               ...
               if(this._roomEngine != null)
               {
                  ...
                  {
                     _loc7_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_89,HabboToolbarIconEnum.ZOOM);
                     _loc7_.iconState = "2";
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_842);
               ...
               if(this.var_1517 != RoomDesktop.const_452)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_327,this.var_1517);
               }
               if(this.var_320 != null)
               {
            ...
            case RoomEngineEvent.const_297:
               ...
               break;
            case RoomEngineRoomColorEvent.const_882:
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.roomWidgetFactory = this.var_1240;
         _loc3_.sessionDataManager = this.var_305;
         _loc3_.roomSessionManager = this.var_15;
         _loc3_.friendList = this._friendList;
         _loc3_.avatarRenderManager = this.var_489;
         _loc3_.inventory = this._inventory;
         _loc3_.toolbar = this.var_170;
         _loc3_.navigator = this._navigator;
         _loc3_.avatarEditor = this.var_1954;
         _loc3_.catalog = this._catalog;
         _loc3_.adManager = this.var_320;
         _loc3_.localization = this._localization;
         _loc3_.habboHelp = this.var_1113;
         _loc3_.moderation = this.var_1007;
         _loc3_.config = this._config;
         _loc3_.soundManager = this.var_354;
         _loc3_.habboTracking = this._habboTracking;
         _loc3_.userDefinedRoomEvents = this.var_1239;
         ...
         _loc3_.createWidget(RoomWidgetEnum.const_782);
         _loc3_.init();
      ...
      public function disposeDesktop(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getWidgetState(RoomWidgetEnum.const_327);
            if(_loc3_ != RoomDesktop.const_452)
            {
               this.var_1517 = _loc3_;
            }
            _loc2_.dispose();
         }
      }
