package com.sulake.habbo.ui
{
   ...
   public class FurnitureStickieWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_777,RoomWidgetStickieSendUpdateMessage.const_924,RoomWidgetStickieSendUpdateMessage.const_448];
      }
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_777:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc6_ != null)
                  {
                     _loc7_ = _loc6_.getString(RoomObjectVariableEnum.const_1199);
                     if(_loc7_.length < 6)
                     {
                        return null;
                     }
            ...
            case RoomWidgetStickieSendUpdateMessage.const_448:
               ...
               break;
            case RoomWidgetStickieSendUpdateMessage.const_924:
