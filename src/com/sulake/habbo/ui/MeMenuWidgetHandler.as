package com.sulake.habbo.ui
{
   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            if(this._inventory && !this._inventory.disposed && this._inventory.events)
            {
               ...
               this._inventory.events.removeEventListener(HabboInventoryHabboClubEvent.const_667,this.onHabboClubSubscriptionChanged);
            }
            if(this.var_170 && !this.var_170.disposed && this.var_170.events)
            {
               this.var_170.events.removeEventListener(HabboToolbarEvent.const_74,this.onHabboToolbarEvent);
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_553,this.onHelpTutorialEvent);
         ...
         if(this._inventory != null)
         {
            ...
            this._inventory.events.addEventListener(HabboInventoryHabboClubEvent.const_667,this.onHabboClubSubscriptionChanged);
         }
         ...
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_553,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this.var_170 != null)
         {
            _loc5_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1083,HabboToolbarIconEnum.MEMENU);
            if(_loc1_ != null)
            {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_903);
         _loc1_.push(RoomWidgetDanceMessage.const_722);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_881);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_750);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_847);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_800);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_895);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_400);
         _loc1_.push(RoomWidgetStopEffectMessage.const_751);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1502);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1036);
         _loc1_.push(RoomWidgetToolbarMessage.const_791);
         _loc1_.push(RoomWidgetToolbarMessage.const_766);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_396);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1443);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1190);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_818);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_760);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_883);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1555);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_683);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_826);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_659);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_760:
               ...
               break;
            case RoomWidgetWaveMessage.const_903:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_722:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_881:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_750:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_847:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_400:
               ...
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1046)
               {
            ...
            case RoomWidgetOpenInventoryMessage.const_895:
               ...
               if(this._inventory != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_1197:
                        this._catalog.openCatalogPage(CatalogPageName.const_1699,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1075:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_291);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1657:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_79);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1466:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_800:
            case RoomWidgetStopEffectMessage.const_751:
               ...
               break;
            case RoomWidgetSetToolbarIconMessage.const_1235:
            ...
            case RoomWidgetNavigateToRoomMessage.const_1036:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_818:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_791:
               ...
               if(this.var_170)
               {
                  this.var_170.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_60,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(this._inventory != null)
                  {
                     _loc12_ = false;
            ...
            case RoomWidgetToolbarMessage.const_766:
               ...
               {
                  this.var_170.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_591,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_396:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_883:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_375,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_683:
            ...
            case RoomWidgetStoreSettingsMessage.const_826:
               ...
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_375,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_659:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
            ...
            case RoomWidgetClothingChangeMessage.const_397:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_864));
               break;
            default:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_871));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_553:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_546));
         }
      }
