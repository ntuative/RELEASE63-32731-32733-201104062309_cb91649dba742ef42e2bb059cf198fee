package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1745:String = "noconvinfo";
      
      private static const const_1746:String = "messageinput";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1407:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1407 = new FriendListTabsView(this._friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         this.var_916 = IWindowContainer(this.var_16.content.findChildByName("main_content"));
         this.var_283 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_1407.prepare(this.var_916);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_1216,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_1051,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_772,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_917,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_772,false);
         ...
         this.var_1406 = ITextWindow(this.var_16.findChildByName("info_text"));
         this.var_1406.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1760 == -1 ? 0 : int(this.var_16.height - this.var_1760);
         var _loc4_:int = this.var_1761 == -1 ? 0 : int(this.var_16.width - this.var_1761);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1057,this._friendList.tabs.findSelectedTab() != null);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_772,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1216,false);
         ...
         this.var_1760 = this.var_16.height;
         this.var_1761 = this.var_16.width;
