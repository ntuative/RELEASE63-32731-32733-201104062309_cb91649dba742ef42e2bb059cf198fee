package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1735:String = "no_reqs_info";
      ...
      private var var_1698:IContainerButtonWindow;
      ...
      {
         this.var_1698 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1699 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1699.procedure = this.onDismissAllButtonClick;
         this.var_1698.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshShading(param1:FriendRequest, param2:Boolean) : void
      {
         ...
         this.method_6(param1.view,"reject");
         this.method_6(param1.view,"accept");
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_1038)
         {
            this._friendList.refreshText(_loc2_,"info_text",true,"${friendlist.request.failed}");
         }
      }
      
      private function method_6(param1:IWindowContainer, param2:String) : void
      {
      ...
      public function method_4(param1:int) : void
      {
         ...
         if(this._friendList && this._friendList.events)
         {
            this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_289,param1));
         }
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_415 && _loc4_.state != FriendRequest.const_376)
            {
               _loc4_.state = FriendRequest.const_376;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_289,_loc4_.requestId));
               }
            }
         }
         this.refresh();
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1698,_loc1_);
         this.setEnabled(this.var_1699,_loc1_);
      }
