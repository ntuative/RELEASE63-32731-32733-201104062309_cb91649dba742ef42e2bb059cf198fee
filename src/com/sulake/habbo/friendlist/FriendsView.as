package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_1898:String = "bg";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_2284:IContainerButtonWindow;
      
      private var var_2286:IContainerButtonWindow;
      
      private var var_2285:IContainerButtonWindow;
      ...
      {
         this.var_2284 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_2286 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_2285 = this.initButton("room_invite",this.onInviteButtonClick,param1);
      ...
      public function method_12(param1:FriendCategory, param2:Boolean) : void
      {
         if(this.var_59 == null)
         {
            return;
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2284,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_2286,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_2285,this.isEnableInviteButton(_loc1_));
