package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_2795:FriendListLookAndFeel;
      
      private var var_422:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_2016:OpenedToWebPopup;
      ...
      private var var_2017:AvatarSearchResults;
      ...
      {
         this.var_2795 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_101 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_2017 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_685.stop();
            this.var_685.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_685 = null;
         }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_2016 = new OpenedToWebPopup(this);
         }
         this.var_2016.show(x,y);
      }
      ...
      public function openFriendList() : void
      {
         ...
         var _loc1_:FriendListTab = this.tabs.findTab(FriendListTab.const_102);
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_89,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(this.var_394.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_304,HabboWindowStyle.const_43,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1088.createAvatarImage(param1,AvatarScaleType.const_90,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_394 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_101.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_101.addCategory(new FriendCategory(FriendCategory.const_1196,this.getText("friendlist.friends")));
         this.var_101.addCategory(new FriendCategory(FriendCategory.const_386,this.getText("friendlist.friends.offlinecaption")));
         ...
         if(!this.var_685)
         {
            this.var_685 = new Timer(120000);
            this.var_685.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_685.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this.var_170.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_133,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_101.findCategory(FriendCategory.const_386);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_394.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_394.addRequest(new FriendRequest(_loc3_));
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_394.addRequestAndUpdateView(_loc3_);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_2017.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      public function declineFriendRequest(param1:int) : void
      {
         ...
         _loc3_.method_4(param1);
      }
      
      private function onUserRights(param1:IMessageEvent) : void
      {
         if(!this.var_833 || !this.var_394)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_833.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_48))
         {
            _loc2_ = this.var_394.vipLimit;
         }
         else if(this.var_833.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_45))
         {
            _loc2_ = this.var_394.clubLimit;
         }
         if(_loc2_ > this.var_394.limit)
         {
            this.var_394.limit = _loc2_;
         }
      }
